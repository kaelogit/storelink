...
function OrderDetailsModal({ order, storeName, isOpen, onClose, onUpdate }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isOpen && order) {
            const fetchItems = async ()=>{
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("order_items").select("*").eq("order_id", order.id);
                setItems(data || []);
            };
            fetchItems();
        }
    ...
    const updateStatus = async (status)=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("orders").update({
            status
        }).eq("id", order.id);
        router.refresh();
        onUpdate();
