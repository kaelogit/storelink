...
"[project]/storelink-app-and-web/store-link-storefront/lib/buyerCategories.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/lib/buyerCategories.ts [app-ssr] (ecmascript)");
...
function FullMarketplaceClient({ initialProducts, categories }) {
    ...
    const [page, setPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(Math.ceil(initialProducts.length / PAGE_SIZE));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const mergeProductRows = async (rows)=>{
            ...
            const { data: storeRows } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("*").in("owner_id", sellerIds);
        ...
        const fetchFiltered = async ()=>{
            ...
            if (selectedCategory !== "all") {
                const { data: catStores } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("owner_id").eq("category", selectedCategory);
            ...
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("storefront_products").select("*").eq("is_active", true).order("created_at", {
                ascending: false
            }).range(0, 40);
            ...
            let processed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["excludeServiceStoresFromMarketplaceProducts"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["applyMarketplaceStoreCaps"])(merged));
            if (debouncedSearch) {
    ...
    const loadMore = async ()=>{
        ...
        if (newProducts && newProducts.length > 0) {
            ...
            const protectedNewData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["excludeServiceStoresFromMarketplaceProducts"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["applyMarketplaceStoreCaps"])(joined));
            setProducts((prev)=>[
                    ...prev,
                    ...protectedNewData
                ]);
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_15a79b15._.js.map