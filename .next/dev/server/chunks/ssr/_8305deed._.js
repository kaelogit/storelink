...
function WaitlistIntelligencePage() {
    ...
    async function fetchEmpireData() {
        ...
        try {
            ...
            const { data: waitlistData, error: wError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('waitlist').select('id, business_name, email, phone, referral_count, created_at').order('created_at', {
                ascending: false
            });
            // 2. Fetch EVERYTHING from the stores table (Ambassadors)
            const { data: vendorData, error: vError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('stores').select('id, name, owner_email, whatsapp_number, referral_count, subscription_plan, created_at').order('referral_count', {
                ascending: false
            });
...
//# sourceMappingURL=_8305deed._.js.map