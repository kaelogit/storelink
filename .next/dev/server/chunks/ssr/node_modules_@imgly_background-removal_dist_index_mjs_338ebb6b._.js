module.exports = [
"[project]/node_modules/@imgly/background-removal/dist/index.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var getOrt = async (useWebGPU)=>{
    ...
    if (useWebGPU) {
        ort = (await (()=>{
            const e = new Error("Cannot find module 'onnxruntime-web/webgpu'");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })()).default;
    } else {
        ort = (await __turbopack_context__.A("[project]/node_modules/onnxruntime-web/dist/ort.node.min.mjs [app-ssr] (ecmascript, async loader)")).default;
    }
    return ort;
};
...
//# sourceMappingURL=node_modules_%40imgly_background-removal_dist_index_mjs_338ebb6b._.js.map