    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isOpen) {
            ...
            const loadData = async ()=>{
                ...
                let tierExpiry;
                let tierStatus;
                const { data: store } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("subscription_plan, subscription_expiry, subscription_status").eq("id", storeId).maybeSingle();
                if (store) {
                    tierPlan = store.subscription_plan;
                    tierExpiry = store.subscription_expiry;
                    tierStatus = store.subscription_status;
                } else {
                    ...
                    if (prof) {
                        tierPlan = prof.subscription_plan;
                        tierExpiry = prof.subscription_expiry ?? undefined;
                        tierStatus = prof.subscription_status ?? undefined;
                    }
                }
                if (tierPlan != null) {
...
;
;
function CategoryManager({ sellerId, legacyStoreId, isOpen, onClose, onSuccess }) {
    ...
    const loadCats = async ()=>{
        let q = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*");
        if (legacyStoreId) {
            q = q.or(`seller_id.eq.${sellerId},store_id.eq.${legacyStoreId}`);
        } else {
    ...
    const addCategory = async (e)=>{
        ...
        if (legacyStoreId) row.store_id = legacyStoreId;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("categories").insert(row);
...
const PROFILE_STOREFRONT_SELECT = "id, display_name, full_name, slug, bio, logo_url, phone_number, location, location_state, location_city, location_country, " + "is_seller, email, subscription_plan, subscription_expiry, subscription_status, " + "verification_status, loyalty_enabled, loyalty_percentage, view_count, account_status, " + "is_store_open, coin_balance, seller_type";
...
function profileRowToLegacyStoreShape(p, opts) {
    const name = p.display_name?.trim() || p.full_name?.trim() || "Store";
...
;
;
/** `stores.id` for category FK when present; profile-only sellers use seller_id only. */ function categoryLegacyStoreId(store) {
    if (store.__surface === "profile") return store.__legacy_store_id ?? null;
    return store.__legacy_store_id ?? store.id ?? null;
}
function DashboardClient({ store, initialProducts, initialOrders, stats }) {
    ...
    const fetchCategories = async ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isProfileBackedStore"])(store)) {
            const bySeller = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").eq("seller_id", uid).order("name");
            if (!bySeller.error && bySeller.data?.length) {
                setLiveCategories(bySeller.data);
                return;
            }
        }
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").eq("store_id", store.id).order("name");
        if (data?.length) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const dashboardSync = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].channel('dashboard-realtime').on('postgres_changes', {
            ...
            schema: 'public',
            table: 'categories',
            filter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isProfileBackedStore"])(store) ? `seller_id=eq.${store.owner_id}` : `store_id=eq.${store.id}`
        }, ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$components$2f$store$2f$CategoryManager$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                legacyStoreId: categoryLegacyStoreId(store),
    ...
    const loadDashboardData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            /** Seller with completed onboarding: dashboard from profile (+ optional legacy `stores` id for RPCs). */ if (prof?.is_seller && (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$onboardingState$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isProfileOnboardingComplete"])(prof)) {
                ...
                setStore(storeForUi);
                const { data: productsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*, categories(name)").eq("seller_id", user.id).order("created_at", {
                    ascending: false
                });
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_019ff0c9._.js.map