(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__64f2736d._.js",
...
"[project]/app/icon.tsx [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/icon--route-entry.js [app-edge-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/icon.tsx [app-edge-route] (ecmascript)");
;
;
if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["default"] !== 'function') {
    throw new Error('Default export is missing in "./icon.tsx"');
}
async function GET(_, ctx) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["default"])({
        params: ctx.params
    });
}
;
}),
"[project]/app/icon--route-entry.js [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "GET",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2d2d$route$2d$entry$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GET"],
    "contentType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["contentType"],
    "runtime",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["runtime"],
    "size",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["size"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2d2d$route$2d$entry$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/app/icon--route-entry.js [app-edge-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/icon.tsx [app-edge-route] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__64f2736d._.js.map