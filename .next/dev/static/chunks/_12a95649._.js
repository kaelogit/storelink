...
function GlobalCartSidebar() {
    _s();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const [liveStoreSettings, setLiveStoreSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobalCartSidebar.useEffect": ()=>{
            const fetchEverything = {
                "GlobalCartSidebar.useEffect.fetchEverything": async ()=>{
                    ...
                    if (cleanPhone && cleanPhone.length >= 10) {
                        const { data: wallet } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_wallets').select('coin_balance').eq('phone_number', cleanPhone).single();
                        if (wallet) {
                    ...
                    if (storeIds.length > 0) {
                        const { data: stores } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stores').select('id, name, self_earning, loyalty_enabled, loyalty_percentage, whatsapp_number').in('id', storeIds);
                        if (stores) {
            ...
            if (isCartOpen) {
                ...
                if (cleanPhone) {
                    const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`wallet-sync-${cleanPhone}`).on('postgres_changes', {
                        event: 'UPDATE',
                        schema: 'public',
                        table: 'user_wallets',
                        filter: `phone_number=eq.${cleanPhone}`
                    }, {
                        "GlobalCartSidebar.useEffect.channel": (payload)=>{
                            setActualBalance(payload.new.coin_balance);
                        }
                    }["GlobalCartSidebar.useEffect.channel"]).subscribe();
                    return ({
                        "GlobalCartSidebar.useEffect": ()=>{
    ...
    const handleCheckout = async (storeId, storeData, items)=>{
        ...
        try {
            ...
            if (coinsToApply > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('decrement_wallet', {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$next$2f$third$2d$parties$2f$dist$2f$google$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendGAEvent"])('event', 'purchase', {
                                ...
                                Object.values(cartByVendor).map(({ store, items })=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            settings.loyalty_enabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(GlobalCartSidebar, "il29Xxojz+1TGK1HNm1Eh9RCLmY=", false, function() {
    return [
