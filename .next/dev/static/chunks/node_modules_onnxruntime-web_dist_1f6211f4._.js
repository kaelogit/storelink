...
"[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.wasm (static in ecmascript)", ((__turbopack_context__) => {

__turbopack_context__.v("/_next/static/media/ort-wasm-simd-threaded.41f6c9e2.wasm");}),
...
var ko = ((i1)=>("TURBOPACK compile-time value", "function") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.z : typeof Proxy < "u" ? new Proxy(i1, {
        get: (e, o)=>(("TURBOPACK compile-time value", "function") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.z : e)[o]
    }) : i1)(function(i1) {
    ...
    throw Error('Dynamic require of "' + i1 + '" is not supported');
});
var O = (i1, e)=>()=>(i1 && (e = i1(i1 = 0)), e);
var mt = (i1, e)=>()=>(e || i1((e = {
            exports: {}
        }).exports, e), e.exports), Or = (i1, e)=>{
    for(var o in e)nn(i1, o, {
        get: e[o],
        enumerable: !0
    });
}, Za = (i1, e, o, t)=>{
    if (e && typeof e == "object" || typeof e == "function") for (let r of Hd(e))!jd.call(i1, r) && r !== o && nn(i1, r, {
        get: ()=>e[r],
        enumerable: !(t = Wd(e, r)) || t.enumerable
    });
    return i1;
};
var rr = (i1, e, o)=>(o = i1 != null ? zd(qd(i1)) : {}, Za(e || !i1 || !i1.__esModule ? nn(o, "default", {
        value: i1,
        enumerable: !0
    }) : o, i1)), on = (i1)=>Za(nn({}, "__esModule", {
        value: !0
    }), i1);
var an, $e, nr, Xd, sn, un = O(()=>{
    "use strict";
    an = new Map, $e = [], nr = (i1, e, o)=>{
        if (e && typeof e.init == "function" && typeof e.createInferenceSessionHandler == "function") {
            let t = an.get(i1);
            if (t === void 0) an.set(i1, {
                backend: e,
                priority: o
            });
            else {
                if (t.priority > o) return;
                if (t.priority === o && t.backend !== e) throw new Error(`cannot register backend "${i1}" using priority ${o}`);
            }
            if (o >= 0) {
                let r = $e.indexOf(i1);
                r !== -1 && $e.splice(r, 1);
        ...
        if (e.aborted) return e.error;
        {
            let o = !!e.initPromise;
            try {
                return o || (e.initPromise = e.backend.init(i1)), await e.initPromise, e.initialized = !0, e.backend;
            } catch (t) {
        ...
        let e = i1.executionProviders || [], o = e.map((u)=>typeof u == "string" ? u : u.name), t = o.length === 0 ? $e : o, r, n = [], s = new Set;
        for (let u of t){
            let l = await Xd(u);
...
var rs, Rt, Bo = O(()=>{
        ...
        set logLevel (i){
            if (i !== void 0) {
                if (typeof i != "string" || [
                    ...
                    "error",
                    "fatal"
                ].indexOf(i) === -1) throw new Error(`Unsupported logging level: ${i}`);
                rs = i;
            }
        },
        get logLevel () {
    ...
    Object.defineProperty(Rt, "logLevel", {
        enumerable: !0
    });
});
var z, ns = O(()=>{
...
var os, is, as = O(()=>{
    ...
    os = (i1, e)=>{
        ...
        o.width = i1.dims[3], o.height = i1.dims[2];
        let t = o.getContext("2d");
        if (t != null) {
            let r, n;
            e?.tensorLayout !== void 0 && e.tensorLayout === "NHWC" ? (r = i1.dims[2], n = i1.dims[3]) : (r = i1.dims[3], n = i1.dims[2]);
            let s = e?.format !== void 0 ? e.format : "RGB", a = e?.norm, u, l;
            a === void 0 || a.mean === void 0 ? u = [
                255,
                255,
                255,
                255
            ] : typeof a.mean == "number" ? u = [
                a.mean,
                a.mean,
                a.mean,
                a.mean
                ...
                a.mean[2],
                0
            ], a.mean[3] !== void 0 && (u[3] = a.mean[3])), a === void 0 || a.bias === void 0 ? l = [
                0,
                0,
                0,
                0
            ] : typeof a.bias == "number" ? l = [
                a.bias,
                a.bias,
                a.bias,
                a.bias
            ...
            for(let v = 0; v < n; v++)for(let S = 0; S < r; S++){
                let L = (i1.data[p++] - l[0]) * u[0], A = (i1.data[d++] - l[1]) * u[1], P = (i1.data[y++] - l[2]) * u[2], M = w === -1 ? 255 : (i1.data[w++] - l[3]) * u[3];
        ...
        if (o != null) {
            let r, n, s;
            e?.tensorLayout !== void 0 && e.tensorLayout === "NHWC" ? (r = i1.dims[2], n = i1.dims[1], s = i1.dims[3]) : (r = i1.dims[3], n = i1.dims[2], s = i1.dims[1]);
            ...
            u === void 0 || u.mean === void 0 ? l = [
                ...
                u.mean[2],
                255
            ], u.mean[3] !== void 0 && (l[3] = u.mean[3])), u === void 0 || u.bias === void 0 ? f = [
                0,
                0,
                0,
                0
            ] : typeof u.bias == "number" ? f = [
                u.bias,
                u.bias,
                u.bias,
                u.bias
            ...
            for(let V = 0; V < n * r; y += d, w += d, v += d, S += d, V++)t.data[y] = (i1.data[L++] - f[0]) * l[0], t.data[w] = (i1.data[A++] - f[1]) * l[1], t.data[v] = (i1.data[P++] - f[2]) * l[2], t.data[S] = M === -1 ? 255 : (i1.data[M++] - f[3]) * l[3];
        } else throw new Error("Can not access image data");
        return t;
    };
});
var Fo, ss, us, ls, fs, cs = O(()=>{
    ...
    ln();
    Fo = (i1, e)=>{
        if (i1 === void 0) throw new Error("Image buffer must be defined");
        ...
        let { height: o, width: t } = e, r = e.norm ?? {
            mean: 255,
            bias: 0
        }, n, s;
        typeof r.mean == "number" ? n = [
            r.mean,
            r.mean,
            r.mean,
            r.mean
        ...
        for(let V = 0; V < l; V++, d += p, w += p, y += p, v += p)f[S++] = (i1[d] + s[0]) / n[0], f[L++] = (i1[y] + s[1]) / n[1], f[A++] = (i1[w] + s[2]) / n[2], P !== -1 && v !== -1 && (f[P++] = (i1[v] + s[3]) / n[3]);
        return u === "RGBA" ? new Lt("float32", f, [
            1,
            4,
            o,
            t
        ...
        let o = typeof HTMLImageElement < "u" && i1 instanceof HTMLImageElement, t = typeof ImageData < "u" && i1 instanceof ImageData, r = typeof ImageBitmap < "u" && i1 instanceof ImageBitmap, n = typeof i1 == "string", s, a = e ?? {}, u = ()=>{
        ...
        if (o) {
            let f = u();
            f.width = i1.width, f.height = i1.height;
            let p = l(f);
            if (p != null) {
                let d = i1.height, y = i1.width;
                ...
                p.drawImage(i1, 0, 0), s = p.getImageData(0, 0, y, d).data;
            } else throw new Error("Can not access image data");
        } else if (t) {
            let f, p;
            if (e !== void 0 && e.resizedWidth !== void 0 && e.resizedHeight !== void 0 ? (f = e.resizedHeight, p = e.resizedWidth) : (f = i1.height, p = i1.width), e !== void 0 && (a = e), a.format = "RGBA", a.height = f, a.width = p, e !== void 0) {
                let d = u();
                d.width = p, d.height = f;
                let y = l(d);
                if (y != null) y.putImageData(i1, 0, 0), s = y.getImageData(0, 0, p, f).data;
                else throw new Error("Can not access image data");
            } else s = i1.data;
        } else if (r) {
            ...
            if (p != null) {
                let d = i1.height, y = i1.width;
                return p.drawImage(i1, 0, 0, y, d), s = p.getImageData(0, 0, y, d).data, a.height = d, a.width = y, Fo(s, a);
            } else throw new Error("Can not access image data");
        } else {
            if (n) return new Promise((f, p)=>{
                ...
                if (!i1 || !y) return p();
                let w = new Image;
                w.crossOrigin = "Anonymous", w.src = i1, w.onload = ()=>{
        ...
        let { width: o, height: t, download: r, dispose: n } = e, s = [
            1,
            t,
            o,
            4
...
var ke, Sr, ps, ds, hs = O(()=>{
    ...
    ke = new Map([
        ...
        if (!ps) {
            ps = !0;
            let i1 = typeof BigInt64Array < "u" && BigInt64Array.from, e = typeof BigUint64Array < "u" && BigUint64Array.from, o = typeof Float16Array < "u" && Float16Array.from;
            i1 && (ke.set("int64", BigInt64Array), Sr.set(BigInt64Array, "int64")), e && (ke.set("uint64", BigUint64Array), Sr.set(BigUint64Array, "uint64")), o ? (ke.set("float16", Float16Array), Sr.set(Float16Array, "float16")) : ke.set("float16", Uint16Array);
        }
    };
});
var ms, bs, gs = O(()=>{
    ...
    ms = (i1)=>{
        ...
        switch(i1.location){
            case "cpu":
                return new Lt(i1.type, i1.data, e);
            case "cpu-pinned":
                return new Lt({
                    location: "cpu-pinned",
                    data: i1.data,
            ...
            case "gpu-buffer":
                return new Lt({
                    location: "gpu-buffer",
                    gpuBuffer: i1.gpuBuffer,
                    type: i1.type,
                    dims: e
                });
            default:
                throw new Error(`tensorReshape: tensor location ${i1.location} is not supported`);
        }
    };
});
var Lt, ln = O(()=>{
...
var ys, xs, Be, Fe, Co = O(()=>{
    ...
    Bo();
    ys = (i1, e)=>{
        (typeof Rt.trace > "u" ? !Rt.wasm.trace : !Rt.trace) || console.timeStamp(`${i1}::ORT::${e}`);
    }, xs = (i1, e)=>{
        let o = new Error().stack?.split(/\r\n|\r|\n/g) || [], t = !1;
        for(let r = 0; r < o.length; r++){
            if (t && !o[r].includes("TRACE_FUNC")) {
                let n = `FUNC_${i1}::${o[r].trim().split(" ")[1]}`;
                e && (n += `::${e}`), ys("CPU", n);
                return;
            }
        ...
        (typeof Rt.trace > "u" ? !Rt.wasm.trace : !Rt.trace) || xs("BEGIN", i1);
    }, Fe = (i1)=>{
        (typeof Rt.trace > "u" ? !Rt.wasm.trace : !Rt.trace) || xs("END", i1);
    };
});
var cn, Ts = O(()=>{
    "use strict";
        ...
        async run(e, o, t) {
            ...
            if (typeof o == "object") {
                ...
                if (Array.isArray(o)) {
                    ...
                    let l = !1, f = Object.getOwnPropertyNames(o);
                    for (let p of this.outputNames)if (f.indexOf(p) !== -1) {
                        let d = o[p];
                        (d === null || d instanceof Tt) && (l = !0, s = !1, r[p] = d);
                    }
                    if (l) {
                        if (typeof t == "object" && t !== null) n = t;
                        else if (typeof t < "u") throw new TypeError("'options' must be an object.");
...
var Jd, pn, Ss = O(()=>{
    ...
    un();
    fn();
    Jd = "Training backend could not be resolved. Make sure you're using the correct configuration & WebAssembly files.", pn = class i1 {
        constructor(e, o, t){
        ...
        static async create(e, o) {
            ...
            if (s.createTrainingSessionHandler) {
                ...
                return new i1(u, !!e.optimizerModel, !!e.evalModel);
        ...
        typeNarrowingForRunStep(e, o, t, r, n) {
            ...
            if (typeof r == "object") {
                ...
                if (Array.isArray(r)) {
                    ...
                    let l = !1, f = Object.getOwnPropertyNames(r);
                    for (let p of o)if (f.indexOf(p) !== -1) {
                        let d = r[p];
                        (d === null || d instanceof Tt) && (l = !0, u = !1, s[p] = d);
                    }
                    if (l) {
                        if (typeof n == "object" && n !== null) a = n;
                        else if (typeof n < "u") throw new TypeError("'options' must be an object.");
...
function Ie(i1, e, o, t) {
    if (e === void 0) return Qd(i1);
    if (o === void 0) dn(i1, e, 1);
    else if (typeof o == "number" && t === void 0) dn(i1, e, o);
    else if (typeof o == "string" && t === void 0) dn(i1, o, 1, e);
    else if (typeof o == "string" && typeof t == "number") dn(i1, o, t, e);
    else throw new TypeError("input is valid");
}
function Qd(i1) {
    return {
        verbose: Ie.verbose.bind(null, i1),
        info: Ie.info.bind(null, i1),
        warning: Ie.warning.bind(null, i1),
        error: Ie.error.bind(null, i1),
        fatal: Ie.fatal.bind(null, i1)
    };
}
function dn(i1, e, o, t) {
    let r = Ar[t || ""] || Ar[""];
    Es[i1] < Es[r.minimalSeverity] || (r.logDateTime && (e = `${new Date().toISOString()}|${e}`), r.logSourceLocation, Zd[r.provider].log(i1, e, t));
}
var Ro, Go, Es, Zd, Ds, Ar, tt, mn, bn, gn, hn, Mt = O(()=>{
    ...
    tt = Ie, mn = class {
        ...
        start() {
            this._started = !0, this._timingEvents = [], this._flushTime = hn(), this._flushPointer = 0;
        }
        stop() {
        ...
        event(e, o, t, r) {
            let n = this._started ? this.begin(e, o, r) : void 0, s = !1, a = t();
...
function Ls(i1, e, o) {
    for (let t of o){
        ...
        if (i1.opType === r) {
            for (let l of e)if ((l.domain === n || l.domain === "ai.onnx" && n === "") && th(l.version, s)) return {
                opImpl: a,
                opInit: u
            };
        }
    }
    throw new TypeError(`cannot resolve operator '${i1.opType}' with opsets: ${e.map((t)=>`${t.domain || "ai.onnx"} v${t.version}`).join(", ")}`);
}
function th(i1, e) {
    if (e.endsWith("+")) {
        ...
        return !isNaN(t) && !isNaN(r) && t <= i1 && i1 <= r;
    } else return Number.parseInt(e, 10) === i1;
}
var $s = O(()=>{
    "use strict";
});
var ks = mt((Mo)=>{
    ...
    var eh = function() {
        function i1(e) {
            ...
            this.value = i1.EMPTY, e && i1.isGuid(e) && (this.value = e);
        }
        return i1.isGuid = function(e) {
            var o = e.toString();
            return e && (e instanceof i1 || i1.validator.test(o));
        }, i1.create = function() {
            return new i1([
                i1.gen(2),
                i1.gen(1),
        ...
        }, i1.createEmpty = function() {
            return new i1("emptyguid");
        }, i1.parse = function(e) {
            return new i1(e);
        }, i1.raw = function() {
            return [
            ...
            return o;
        }, i1.prototype.equals = function(e) {
            return i1.isGuid(e) && this.value === e.toString();
        }, i1.prototype.isEmpty = function() {
            return this.value === i1.EMPTY;
        }, i1.prototype.toString = function() {
            return this.value;
        }, i1.prototype.toJSON = function() {
            return {
                value: this.value
            };
        }, i1.validator = new RegExp("^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}$", "i"), i1.EMPTY = "00000000-0000-0000-0000-000000000000", i1;
    }();
    Mo.Guid = eh;
});
function rt(i1, e, o) {
    this.low = i1 | 0, this.high = e | 0, this.unsigned = !!o;
}
function Pt(i1) {
    return (i1 && i1.__isLong__) === !0;
}
function Bs(i1) {
    var e = Math.clz32(i1 & -i1);
    return i1 ? 31 - e : e;
}
function Ce(i1, e) {
    var o, t, r;
    return e ? (i1 >>>= 0, (r = 0 <= i1 && i1 < 256) && (t = Cs[i1], t) ? t : (o = J(i1, 0, !0), r && (Cs[i1] = o), o)) : (i1 |= 0, (r = -128 <= i1 && i1 < 128) && (t = Fs[i1], t) ? t : (o = J(i1, i1 < 0 ? -1 : 0, !1), r && (Fs[i1] = o), o));
}
function Vt(i1, e) {
    if (isNaN(i1)) return e ? he : Jt;
    if (e) {
        if (i1 < 0) return he;
        if (i1 >= Ms) return zs;
    } else {
        if (i1 <= -Rs) return Ft;
        if (i1 + 1 >= Rs) return Vs;
    }
    return i1 < 0 ? Vt(-i1, e).neg() : J(i1 % ir | 0, i1 / ir | 0, e);
}
function J(i1, e, o) {
    return new rt(i1, e, o);
}
function Vo(i1, e, o) {
    if (i1.length === 0) throw Error("empty string");
    if (typeof e == "number" ? (o = e, e = !1) : e = !!e, i1 === "NaN" || i1 === "Infinity" || i1 === "+Infinity" || i1 === "-Infinity") return e ? he : Jt;
    if (o = o || 10, o < 2 || 36 < o) throw RangeError("radix");
    var t;
    if ((t = i1.indexOf("-")) > 0) throw Error("interior hyphen");
    if (t === 0) return Vo(i1.substring(1), e, o).neg();
    for(var r = Vt(yn(o, 8)), n = Jt, s = 0; s < i1.length; s += 8){
        var a = Math.min(8, i1.length - s), u = parseInt(i1.substring(s, s + a), o);
        if (a < 8) {
            var l = Vt(yn(o, a));
            n = n.mul(l).add(Vt(u));
...
function Yt(i1, e) {
    return typeof i1 == "number" ? Vt(i1, e) : typeof i1 == "string" ? Vo(i1, e) : J(i1.low, i1.high, typeof e == "boolean" ? e : i1.unsigned);
}
var Ut, Fs, Cs, yn, Ns, rh, ir, Ms, Rs, Gs, Jt, he, or, Us, Uo, Vs, zs, Ft, D, me, zo = O(()=>{
    Ut = null;
    try {
        Ut = new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([
            0,
            97,
            115,
            109,
    ...
    D.equals = function(e) {
        return Pt(e) || (e = Yt(e)), this.unsigned !== e.unsigned && this.high >>> 31 === 1 && e.high >>> 31 === 1 ? !1 : this.high === e.high && this.low === e.low;
    };
    D.eq = D.equals;
...
var T, xn = O(()=>{
    ...
    T.isLittleEndian = new Uint16Array(new Uint8Array([
        1,
        0
    ]).buffer)[0] === 1;
    T.Long = function(i1, e) {
        this.low = i1 | 0, this.high = e | 0;
    };
    T.Long.create = function(i1, e) {
        return i1 == 0 && e == 0 ? T.Long.ZERO : new T.Long(i1, e);
    };
    T.Long.prototype.toFloat64 = function() {
        return (this.low >>> 0) + this.high * 4294967296;
    };
    T.Long.prototype.equals = function(i1) {
        return this.low == i1.low && this.high == i1.high;
    };
    T.Long.ZERO = new T.Long(0, 0);
    T.Builder = function(i1) {
        if (i1) var e = i1;
        else var e = 1024;
        this.bb = T.ByteBuffer.allocate(e), this.space = e, this.minalign = 1, this.vtable = null, this.vtable_in_use = 0, this.isNested = !1, this.object_start = 0, this.vtables = [], this.vector_num_elems = 0, this.force_defaults = !1;
    };
    ...
    T.Builder.prototype.forceDefaults = function(i1) {
        this.force_defaults = i1;
    };
    ...
    T.Builder.prototype.prep = function(i1, e) {
        i1 > this.minalign && (this.minalign = i1);
        for(var o = ~(this.bb.capacity() - this.space + e) + 1 & i1 - 1; this.space < o + i1 + e;){
            var t = this.bb.capacity();
            this.bb = T.Builder.growByteBuffer(this.bb), this.space += this.bb.capacity() - t;
        }
        this.pad(o);
    };
    T.Builder.prototype.pad = function(i1) {
        for(var e = 0; e < i1; e++)this.bb.writeInt8(--this.space, 0);
    };
    T.Builder.prototype.writeInt8 = function(i1) {
        this.bb.writeInt8(this.space -= 1, i1);
    };
    T.Builder.prototype.writeInt16 = function(i1) {
        this.bb.writeInt16(this.space -= 2, i1);
    };
    T.Builder.prototype.writeInt32 = function(i1) {
        this.bb.writeInt32(this.space -= 4, i1);
    };
    T.Builder.prototype.writeInt64 = function(i1) {
        this.bb.writeInt64(this.space -= 8, i1);
    };
    T.Builder.prototype.writeFloat32 = function(i1) {
        this.bb.writeFloat32(this.space -= 4, i1);
    };
    T.Builder.prototype.writeFloat64 = function(i1) {
        this.bb.writeFloat64(this.space -= 8, i1);
    };
    T.Builder.prototype.addInt8 = function(i1) {
        this.prep(1, 0), this.writeInt8(i1);
    };
    T.Builder.prototype.addInt16 = function(i1) {
        this.prep(2, 0), this.writeInt16(i1);
    };
    T.Builder.prototype.addInt32 = function(i1) {
        this.prep(4, 0), this.writeInt32(i1);
    };
    T.Builder.prototype.addInt64 = function(i1) {
        this.prep(8, 0), this.writeInt64(i1);
    };
    T.Builder.prototype.addFloat32 = function(i1) {
        this.prep(4, 0), this.writeFloat32(i1);
    };
    T.Builder.prototype.addFloat64 = function(i1) {
        this.prep(8, 0), this.writeFloat64(i1);
    };
    T.Builder.prototype.addFieldInt8 = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addInt8(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldInt16 = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addInt16(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldInt32 = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addInt32(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldInt64 = function(i1, e, o) {
        (this.force_defaults || !e.equals(o)) && (this.addInt64(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldFloat32 = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addFloat32(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldFloat64 = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addFloat64(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldOffset = function(i1, e, o) {
        (this.force_defaults || e != o) && (this.addOffset(e), this.slot(i1));
    };
    T.Builder.prototype.addFieldStruct = function(i1, e, o) {
        e != o && (this.nested(e), this.slot(i1));
    };
    T.Builder.prototype.nested = function(i1) {
        if (i1 != this.offset()) throw new Error("FlatBuffers: struct must be serialized inline.");
    };
    ...
    T.Builder.prototype.slot = function(i1) {
        this.vtable[i1] = this.offset();
    };
    T.Builder.prototype.offset = function() {
        return this.bb.capacity() - this.space;
    };
    T.Builder.growByteBuffer = function(i1) {
        var e = i1.capacity();
        if (e & 3221225472) throw new Error("FlatBuffers: cannot grow buffer beyond 2 gigabytes.");
        var o = e << 1, t = T.ByteBuffer.allocate(o);
        return t.setPosition(o - e), t.bytes().set(i1.bytes(), o - e), t;
    };
    T.Builder.prototype.addOffset = function(i1) {
        this.prep(T.SIZEOF_INT, 0), this.writeInt32(this.offset() - i1 + T.SIZEOF_INT);
    };
    T.Builder.prototype.startObject = function(i1) {
        this.notNested(), this.vtable == null && (this.vtable = []), this.vtable_in_use = i1;
        for(var e = 0; e < i1; e++)this.vtable[e] = 0;
    ...
    T.Builder.prototype.endObject = function() {
        ...
        this.addInt32(0);
        for(var i1 = this.offset(), e = this.vtable_in_use - 1; e >= 0 && this.vtable[e] == 0; e--);
        for(var o = e + 1; e >= 0; e--)this.addInt16(this.vtable[e] != 0 ? i1 - this.vtable[e] : 0);
        var t = 2;
        this.addInt16(i1 - this.object_start);
        ...
        return n ? (this.space = this.bb.capacity() - i1, this.bb.writeInt32(this.space, n - i1)) : (this.vtables.push(this.offset()), this.bb.writeInt32(this.bb.capacity() - i1, this.offset() - i1)), this.isNested = !1, i1;
    };
    T.Builder.prototype.finish = function(i1, e, o) {
        ...
        this.prep(this.minalign, T.SIZEOF_INT + t), this.addOffset(i1), t && this.addInt32(this.bb.capacity() - this.space), this.bb.setPosition(this.space);
    };
    T.Builder.prototype.finishSizePrefixed = function(i1, e) {
        this.finish(i1, e, !0);
    };
    T.Builder.prototype.requiredField = function(i1, e) {
        var o = this.bb.capacity() - i1, t = o - this.bb.readInt32(o), r = this.bb.readInt16(t + e) != 0;
        if (!r) throw new Error("FlatBuffers: field " + e + " must be set");
    };
    T.Builder.prototype.startVector = function(i1, e, o) {
        this.notNested(), this.vector_num_elems = e, this.prep(T.SIZEOF_INT, i1 * e), this.prep(o, i1 * e);
    };
    T.Builder.prototype.endVector = function() {
        return this.writeInt32(this.vector_num_elems), this.offset();
    };
    T.Builder.prototype.createString = function(i1) {
        if (i1 instanceof Uint8Array) var e = i1;
        else for(var e = [], o = 0; o < i1.length;){
            var t, r = i1.charCodeAt(o++);
            if (r < 55296 || r >= 56320) t = r;
            else {
                var n = i1.charCodeAt(o++);
    ...
    T.Builder.prototype.createLong = function(i1, e) {
        return T.Long.create(i1, e);
    };
    T.ByteBuffer = function(i1) {
        this.bytes_ = i1, this.position_ = 0;
    };
    T.ByteBuffer.allocate = function(i1) {
        return new T.ByteBuffer(new Uint8Array(i1));
    };
    ...
    T.ByteBuffer.prototype.setPosition = function(i1) {
        this.position_ = i1;
    };
    T.ByteBuffer.prototype.capacity = function() {
        return this.bytes_.length;
    };
    T.ByteBuffer.prototype.readInt8 = function(i1) {
        return this.readUint8(i1) << 24 >> 24;
    };
    T.ByteBuffer.prototype.readUint8 = function(i1) {
        return this.bytes_[i1];
    };
    T.ByteBuffer.prototype.readInt16 = function(i1) {
        return this.readUint16(i1) << 16 >> 16;
    };
    T.ByteBuffer.prototype.readUint16 = function(i1) {
        return this.bytes_[i1] | this.bytes_[i1 + 1] << 8;
    };
    T.ByteBuffer.prototype.readInt32 = function(i1) {
        return this.bytes_[i1] | this.bytes_[i1 + 1] << 8 | this.bytes_[i1 + 2] << 16 | this.bytes_[i1 + 3] << 24;
    };
    T.ByteBuffer.prototype.readUint32 = function(i1) {
        return this.readInt32(i1) >>> 0;
    };
    T.ByteBuffer.prototype.readInt64 = function(i1) {
        return new T.Long(this.readInt32(i1), this.readInt32(i1 + 4));
    };
    T.ByteBuffer.prototype.readUint64 = function(i1) {
        return new T.Long(this.readUint32(i1), this.readUint32(i1 + 4));
    };
    T.ByteBuffer.prototype.readFloat32 = function(i1) {
        return T.int32[0] = this.readInt32(i1), T.float32[0];
    };
    T.ByteBuffer.prototype.readFloat64 = function(i1) {
        return T.int32[T.isLittleEndian ? 0 : 1] = this.readInt32(i1), T.int32[T.isLittleEndian ? 1 : 0] = this.readInt32(i1 + 4), T.float64[0];
    };
    T.ByteBuffer.prototype.writeInt8 = function(i1, e) {
        this.bytes_[i1] = e;
    };
    T.ByteBuffer.prototype.writeUint8 = function(i1, e) {
        this.bytes_[i1] = e;
    };
    T.ByteBuffer.prototype.writeInt16 = function(i1, e) {
        this.bytes_[i1] = e, this.bytes_[i1 + 1] = e >> 8;
    };
    T.ByteBuffer.prototype.writeUint16 = function(i1, e) {
        this.bytes_[i1] = e, this.bytes_[i1 + 1] = e >> 8;
    };
    T.ByteBuffer.prototype.writeInt32 = function(i1, e) {
        this.bytes_[i1] = e, this.bytes_[i1 + 1] = e >> 8, this.bytes_[i1 + 2] = e >> 16, this.bytes_[i1 + 3] = e >> 24;
    };
    T.ByteBuffer.prototype.writeUint32 = function(i1, e) {
        this.bytes_[i1] = e, this.bytes_[i1 + 1] = e >> 8, this.bytes_[i1 + 2] = e >> 16, this.bytes_[i1 + 3] = e >> 24;
    };
    T.ByteBuffer.prototype.writeInt64 = function(i1, e) {
        this.writeInt32(i1, e.low), this.writeInt32(i1 + 4, e.high);
    };
    T.ByteBuffer.prototype.writeUint64 = function(i1, e) {
        this.writeUint32(i1, e.low), this.writeUint32(i1 + 4, e.high);
    };
    T.ByteBuffer.prototype.writeFloat32 = function(i1, e) {
        T.float32[0] = e, this.writeInt32(i1, T.int32[0]);
    };
    T.ByteBuffer.prototype.writeFloat64 = function(i1, e) {
        T.float64[0] = e, this.writeInt32(i1, T.int32[T.isLittleEndian ? 0 : 1]), this.writeInt32(i1 + 4, T.int32[T.isLittleEndian ? 1 : 0]);
    };
    T.ByteBuffer.prototype.getBufferIdentifier = function() {
        ...
        for(var i1 = "", e = 0; e < T.FILE_IDENTIFIER_LENGTH; e++)i1 += String.fromCharCode(this.readInt8(this.position_ + T.SIZEOF_INT + e));
        return i1;
    };
    T.ByteBuffer.prototype.__offset = function(i1, e) {
        var o = i1 - this.readInt32(i1);
        return e < this.readInt16(o) ? this.readInt16(o + e) : 0;
    };
    T.ByteBuffer.prototype.__union = function(i1, e) {
        return i1.bb_pos = e + this.readInt32(e), i1.bb = this, i1;
    };
    T.ByteBuffer.prototype.__string = function(i1, e) {
        i1 += this.readInt32(i1);
        var o = this.readInt32(i1), t = "", r = 0;
        if (i1 += T.SIZEOF_INT, e === T.Encoding.UTF8_BYTES) return this.bytes_.subarray(i1, i1 + o);
        for(; r < o;){
            var n, s = this.readUint8(i1 + r++);
            if (s < 192) n = s;
            else {
                var a = this.readUint8(i1 + r++);
                if (s < 224) n = (s & 31) << 6 | a & 63;
                else {
                    var u = this.readUint8(i1 + r++);
                    if (s < 240) n = (s & 15) << 12 | (a & 63) << 6 | u & 63;
                    else {
                        var l = this.readUint8(i1 + r++);
    ...
    T.ByteBuffer.prototype.__indirect = function(i1) {
        return i1 + this.readInt32(i1);
    };
    T.ByteBuffer.prototype.__vector = function(i1) {
        return i1 + this.readInt32(i1) + T.SIZEOF_INT;
    };
    T.ByteBuffer.prototype.__vector_len = function(i1) {
        return this.readInt32(i1 + this.readInt32(i1));
    };
    T.ByteBuffer.prototype.__has_identifier = function(i1) {
        if (i1.length != T.FILE_IDENTIFIER_LENGTH) throw new Error("FlatBuffers: file identifier must be length " + T.FILE_IDENTIFIER_LENGTH);
        for(var e = 0; e < T.FILE_IDENTIFIER_LENGTH; e++)if (i1.charCodeAt(e) != this.readInt8(this.position_ + T.SIZEOF_INT + e)) return !1;
        return !0;
    };
    T.ByteBuffer.prototype.createLong = function(i1, e) {
        return T.Long.create(i1, e);
    };
});
var F, Pr = O(()=>{
    ...
    function Zs(i1) {
        return typeof Float32Array < "u" ? function() {
            var e = new Float32Array([
                -0
            ]), o = new Uint8Array(e.buffer), t = o[3] === 128;
            function r(u, l, f) {
            ...
            i1.writeFloatLE = t ? r : n, i1.writeFloatBE = t ? n : r;
            function s(u, l) {
            ...
            i1.readFloatLE = t ? s : a, i1.readFloatBE = t ? a : s;
        }() : function() {
            function e(t, r, n, s) {
                var a = r < 0 ? 1 : 0;
            ...
            i1.writeFloatLE = e.bind(null, Qs), i1.writeFloatBE = e.bind(null, tu);
            function o(t, r, n) {
            ...
            i1.readFloatLE = o.bind(null, eu), i1.readFloatBE = o.bind(null, ru);
        }(), typeof Float64Array < "u" ? function() {
            var e = new Float64Array([
                -0
            ]), o = new Uint8Array(e.buffer), t = o[7] === 128;
            function r(u, l, f) {
            ...
            i1.writeDoubleLE = t ? r : n, i1.writeDoubleBE = t ? n : r;
            function s(u, l) {
            ...
            i1.readDoubleLE = t ? s : a, i1.readDoubleBE = t ? a : s;
        }() : function() {
            ...
            i1.writeDoubleLE = e.bind(null, Qs, 0, 4), i1.writeDoubleBE = e.bind(null, tu, 4, 0);
            ...
            i1.readDoubleLE = o.bind(null, eu, 0, 4), i1.readDoubleBE = o.bind(null, ru, 4, 0);
        }(), i1;
    }
    function Qs(i1, e, o) {
        e[o] = i1 & 255, e[o + 1] = i1 >>> 8 & 255, e[o + 2] = i1 >>> 16 & 255, e[o + 3] = i1 >>> 24;
    }
    function tu(i1, e, o) {
        e[o] = i1 >>> 24, e[o + 1] = i1 >>> 16 & 255, e[o + 2] = i1 >>> 8 & 255, e[o + 3] = i1 & 255;
    }
    function eu(i1, e) {
        return (i1[e] | i1[e + 1] << 8 | i1[e + 2] << 16 | i1[e + 3] << 24) >>> 0;
    }
    function ru(i1, e) {
        return (i1[e] << 24 | i1[e + 1] << 16 | i1[e + 2] << 8 | i1[e + 3]) >>> 0;
    }
});
...
var Oe = mt((Ho)=>{
    ...
    N.pool = lu();
    N.LongBits = cu();
    N.isNode = !!(("TURBOPACK compile-time value", "object") < "u" && /*TURBOPACK member replacement*/ __turbopack_context__.g && /*TURBOPACK member replacement*/ __turbopack_context__.g.process && /*TURBOPACK member replacement*/ __turbopack_context__.g.process.versions && /*TURBOPACK member replacement*/ __turbopack_context__.g.process.versions.node);
    N.global = N.isNode && /*TURBOPACK member replacement*/ __turbopack_context__.g || typeof window < "u" && window || typeof self < "u" && self || Ho;
    ...
    N.Buffer = function() {
        try {
            var i1 = N.inquire("buffer").Buffer;
            return i1.prototype.utf8Write ? i1 : null;
        } catch  {
            return null;
        }
    }();
    ...
    function pu(i1, e, o) {
        for(var t = Object.keys(e), r = 0; r < t.length; ++r)(i1[t[r]] === void 0 || !o) && (i1[t[r]] = e[t[r]]);
        return i1;
    }
    N.merge = pu;
    ...
    N._configure = function() {
        ...
        N._Buffer_from = i1.from !== Uint8Array.from && i1.from || function(o, t) {
            return new i1(o, t);
        }, N._Buffer_allocUnsafe = i1.allocUnsafe || function(o) {
            return new i1(o);
        };
    };
});
var Zo = mt((Ky, gu)=>{
    ...
    function Dr(i1, e, o) {
        this.fn = i1, this.len = e, this.next = void 0, this.val = o;
    }
    function Xo() {}
    function ah(i1) {
        this.head = i1.head, this.tail = i1.tail, this.len = i1.len, this.next = i1.states;
    }
    function X() {
    ...
    function sh(i1, e, o) {
        for(; i1 > 127;)e[o++] = i1 & 127 | 128, i1 >>>= 7;
        e[o] = i1;
    }
    function Jo(i1, e) {
        this.len = i1, this.next = void 0, this.val = e;
    }
    ...
    function Yo(i1, e, o) {
        for(; i1.hi;)e[o++] = i1.lo & 127 | 128, i1.lo = (i1.lo >>> 7 | i1.hi << 25) >>> 0, i1.hi >>>= 7;
        for(; i1.lo > 127;)e[o++] = i1.lo & 127 | 128, i1.lo = i1.lo >>> 7;
        e[o++] = i1.lo;
    }
    ...
    X._configure = function(i1) {
        qo = i1, X.create = bu(), qo._configure();
    };
});
var Tu = mt((Jy, xu)=>{
    "use strict";
    ...
    function lh(i1, e, o) {
        i1.length < 40 ? Se.utf8.write(i1, e, o) : e.utf8Write ? e.utf8Write(i1, o) : e.write(i1, o);
    }
...
var ei = mt((Yy, Ou)=>{
    ...
    function te(i1, e) {
        return RangeError("index out of range: " + i1.pos + " + " + (e || 1) + " > " + i1.len);
    }
    function ct(i1) {
        this.buf = i1, this.pos = 0, this.len = i1.length;
    }
    ...
    function Qo() {
        var i1 = new Iu(0, 0), e = 0;
        if (this.len - this.pos > 4) {
            for(; e < 4; ++e)if (i1.lo = (i1.lo | (this.buf[this.pos] & 127) << e * 7) >>> 0, this.buf[this.pos++] < 128) return i1;
            if (i1.lo = (i1.lo | (this.buf[this.pos] & 127) << 28) >>> 0, i1.hi = (i1.hi | (this.buf[this.pos] & 127) >> 4) >>> 0, this.buf[this.pos++] < 128) return i1;
            e = 0;
        } else {
            for(; e < 3; ++e){
                if (this.pos >= this.len) throw te(this);
                if (i1.lo = (i1.lo | (this.buf[this.pos] & 127) << e * 7) >>> 0, this.buf[this.pos++] < 128) return i1;
            }
            return i1.lo = (i1.lo | (this.buf[this.pos++] & 127) << e * 7) >>> 0, i1;
        }
        if (this.len - this.pos > 4) {
            for(; e < 5; ++e)if (i1.hi = (i1.hi | (this.buf[this.pos] & 127) << e * 7 + 3) >>> 0, this.buf[this.pos++] < 128) return i1;
        } else for(; e < 5; ++e){
            if (this.pos >= this.len) throw te(this);
            if (i1.hi = (i1.hi | (this.buf[this.pos] & 127) << e * 7 + 3) >>> 0, this.buf[this.pos++] < 128) return i1;
        }
    ...
    function In(i1, e) {
        return (i1[e - 4] | i1[e - 3] << 8 | i1[e - 2] << 16 | i1[e - 1] << 24) >>> 0;
    }
    ...
    ct.prototype.skipType = function(i1) {
        switch(i1){
            case 0:
                this.skip();
                break;
            ...
            case 2:
                ...
                break;
            case 3:
                for(; (i1 = this.uint32() & 7) !== 4;)this.skipType(i1);
                break;
            case 5:
                this.skip(4);
                break;
            default:
                throw Error("invalid wire type " + i1 + " at offset " + this.pos);
        }
        return this;
    };
    ct._configure = function(i1) {
        ti = i1, ct.create = _u(), ti._configure();
        var e = Qt.Long ? "toLong" : "toNumber";
        Qt.merge(ct.prototype, {
            int64: function() {
                return Qo.call(this)[e](!1);
            },
            uint64: function() {
                return Qo.call(this)[e](!0);
            },
            sint64: function() {
                return Qo.call(this).zzDecode()[e](!1);
            },
            fixed64: function() {
                return vu.call(this)[e](!0);
            },
            sfixed64: function() {
                return vu.call(this)[e](!1);
            }
        });
    };
});
...
var Lu = mt((Qy, Du)=>{
    ...
    function Lr(i1, e, o) {
        if (typeof i1 != "function") throw TypeError("rpcImpl must be a function");
        ri.EventEmitter.call(this), this.rpcImpl = i1, this.requestDelimited = !!e, this.responseDelimited = !!o;
    }
    Lr.prototype.rpcCall = function i1(e, o, t, r, n) {
        if (!r) throw TypeError("request must be specified");
        var s = this;
        if (!n) return ri.asPromise(i1, s, e, o, t, r);
        if (!s.rpcImpl) {
            setTimeout(function() {
...
function ur(i1, e) {
    if (!i1) throw new Error(typeof e == "string" ? e : e());
}
function kr(i1) {
    return new TextDecoder().decode(i1);
}
var ot, Ge, ni, $t, _n, _t, Nt, B, $r, Me, Ue, Ve, Y = O(()=>{
    ...
    Ge = class {
        ...
        static calc(e, o, t, r, n) {
            let s = i1.calcShape(e.dims, o.dims);
            if (s) {
                if (r && !B.areEqual(s, e.dims)) return;
                let a = B.size(s), u = r ? e : new bt(s, n || e.type);
                if (s.length === 0) u.set([], t(e.get([]), o.get([])));
                else {
                    let l = new Array(s.length), f = new Array(e.dims.length), p = new Array(o.dims.length), d = 0, y = 0, w = !1, v = !1;
                    e.dims.length === 0 && (d = e.get([]), w = !0), o.dims.length === 0 && (y = o.get([]), v = !0);
                    let S;
                    for(let L = 0; L < a; L++){
                        S = L;
                        for(let A = s.length - 1; A >= 0; A--)l[A] = S % s[A], S = Math.floor(S / s[A]);
                        w || (i1.fillIndex(l, e.dims, f), d = e.get(f)), v || (i1.fillIndex(l, o.dims, p), y = o.get(p)), u.set(l, t(d, y));
                    }
                }
                return u;
            }
        ...
        static tensorValueTypeFromProto(e) {
            return {
                tensorType: i1.tensorDataTypeFromProto(e.elemType),
                shape: {
                    dims: i1.tensorDimsFromProto(e.shape.dim.map((o)=>o.dimValue))
                }
            };
        }
        ...
        static longToNumber(e, o) {
            return me.isLong(e) ? e.toNumber() : e instanceof T.Long ? me.fromValue({
                low: e.low,
                high: e.high,
                unsigned: o ?? !1
            }).toNumber() : e;
        ...
        static size(e) {
            return i1.getSizeFromDimensionRange(e, 0, e.length);
        }
        static sizeFromDimension(e, o) {
            ...
            return i1.getSizeFromDimensionRange(e, o, e.length);
        }
        static sizeToDimension(e, o) {
            ...
            return i1.getSizeFromDimensionRange(e, 0, o);
        }
        ...
        static calculateReshapedDims(e, o) {
            if (o.length === 0) {
                if (e.length === 0 || i1.size(e) === 1) return [];
        ...
        static unsqueezeShape(e, o) {
            ...
            for(let n = 0; n < o.length; n++){
                let s = i1.normalizeAxis(o[n], t.length);
        ...
        static adjustPadsBasedOnAutoPad(e, o, t, r, n, s) {
            if (s) {
                ...
                for(let a = 0; a < e.length - 2; a++)i1.adjustPadAndReturnShape(e[a + 2], o[a], t[a], r[a], n, a, a + e.length - 2, s);
            }
        }
        static computePoolOutputShape(e, o, t, r, n, s, a) {
            ...
            return i1.computeShapeHelper(e, o, u, t, r, n, s, a), u;
        }
        static computeConvOutputShape(e, o, t, r, n, s, a) {
            ...
            return i1.computeShapeHelper(!1, e, u, t, r, n, s, a), u;
        }
        static computeShapeHelper(e, o, t, r, n, s, a, u) {
            if (e) for(let l = 0; l < o.length - 2; l++)t.push(1);
            else for(let l = 0; l < o.length - 2; l++)t.push(i1.adjustPadAndReturnShape(o[l + 2], r[l], n[l], s[l], a, l, l + o.length - 2, u));
        }
...
function ph(i1) {
    switch(i1){
        ...
        case "float64":
            return 8;
        default:
            throw new Error(`cannot calculate sizeof() on type ${i1}`);
    }
}
function Vu(i1) {
    switch(i1){
        ...
        case H.onnx.TensorProto.DataType.UINT64:
            return 8;
        default:
            throw new Error(`cannot calculate sizeof() on type ${H.onnx.TensorProto.DataType[i1]}`);
    }
}
function dh(i1, e) {
    return new (Hu(e))(i1);
...
function ii(i1, e) {
    if (e === H.onnx.TensorProto.DataType.INT64 || e === oi.TensorDataType.INT64) {
        if (i1.greaterThanOrEqual(2147483648) || i1.lessThan(-2147483648)) throw new TypeError("int64 is not supported");
        ...
        if (i1.greaterThanOrEqual(4294967296) || i1.lessThan(0)) throw new TypeError("uint64 is not supported");
...
function zu(i1, e, o) {
    switch(e){
        case H.onnx.TensorProto.DataType.BOOL:
        case H.onnx.TensorProto.DataType.UINT8:
            return i1.getUint8(o);
        case H.onnx.TensorProto.DataType.INT8:
            return i1.getInt8(o);
        case H.onnx.TensorProto.DataType.UINT16:
            return i1.getUint16(o, !0);
        case H.onnx.TensorProto.DataType.INT16:
            return i1.getInt16(o, !0);
        case H.onnx.TensorProto.DataType.FLOAT:
            return i1.getFloat32(o, !0);
        case H.onnx.TensorProto.DataType.INT32:
            return i1.getInt32(o, !0);
        case H.onnx.TensorProto.DataType.UINT32:
            return i1.getUint32(o, !0);
        case H.onnx.TensorProto.DataType.INT64:
            return ii(me.fromBits(i1.getUint32(o, !0), i1.getUint32(o + 4, !0), !1), e);
        case H.onnx.TensorProto.DataType.DOUBLE:
            return i1.getFloat64(o, !0);
        case H.onnx.TensorProto.DataType.UINT64:
            return ii(me.fromBits(i1.getUint32(o, !0), i1.getUint32(o + 4, !0), !0), e);
        default:
...
var Wu, H, oi, bt, ze = O(()=>{
    ...
    H = rr(sr());
    Y();
    oi = F.experimental.fbs, bt = class i1 {
        ...
        static fromProto(e) {
            ...
            let o = _t.tensorDataTypeFromProto(e.dataType), t = _t.tensorDimsFromProto(e.dims), r = new i1(t, o);
        ...
        static fromData(e, o, t) {
            return new i1(o, t, void 0, void 0, e);
        }
        static fromOrtTensor(e) {
            if (!e) throw new Error("cannot construct Value from an empty tensor");
            let o = _t.tensorDimsFromORTFormat(e), t = _t.tensorDataTypeFromProto(e.dataType()), r = new i1(o, t);
...
function On(i1) {
    return ur(typeof i1 < "u" && i1.length !== 0, ()=>"empty string found for sampler name"), "get" + i1.charAt(0).toUpperCase() + i1.slice(1);
}
function Ku(i1) {
    return ur(typeof i1 < "u" && i1.length !== 0, ()=>"empty string found for sampler name"), "get" + i1.charAt(0).toUpperCase() + i1.slice(1) + "AtOutCoords";
}
function lr(i1, e) {
    let o = JSON.parse(JSON.stringify(i1));
    return o = e, o;
}
function fr(i1, e) {
    return e.map((o)=>i1[o]).join(", ");
}
function kt(i1) {
    if (i1 <= 1) return "int";
    if (i1 === 2) return "ivec2";
    if (i1 === 3) return "ivec3";
    if (i1 === 4) return "ivec4";
    if (i1 === 5) return "ivec5";
    if (i1 === 6) return "ivec6";
    throw Error(`GPU for rank ${i1} is not yet supported`);
}
function ee(i1 = 6) {
    return [
        "x",
...
function yh(i1, e, o) {
    ...
    if (i1 === 1) return `rc > ${e[0]}`;
    let t = "";
    for(let r = i1 - 2; r < i1; r++)t += `${o[r]} >= ${e[r - i1 + 2]}`, r < i1 - 1 && (t += "||");
    return t;
}
function xh(i1, e) {
    let o = i1.length;
...
var Ju, gh, Yu, Zu = O(()=>{
    ...
    Ju = {
        ...
        let o = G(i1.session.backend.glContext.version), t = e.dims, r = t.length, n = e.dims.length, s = kt(n), a = cr("rc", n), u = Th(n, a, t[t.length - 2], t[t.length - 1]), l;
        r === 0 ? l = [
            1,
            1
        ] : r === 1 ? l = [
...
function si(i1) {
    ...
    let e = 1;
    for(let o = 0; o < i1.length - 2; ++o)e *= i1[o];
    return [
        e,
        i1.length > 1 ? i1[i1.length - 2] : 1,
        i1[i1.length - 1]
    ];
}
function tl(i1, e) {
    let o = !1;
    return i1.length === 0 || e.length === 0 ? o = !0 : i1.length < 2 || e.length < 2 ? o = i1[i1.length - 1] === e[e.length - 1] : o = i1[i1.length - 1] === e[e.length - 1] && i1[i1.length - 2] === e[e.length - 2], o;
}
function Ih(i1) {
    let e = B.computeStrides(i1), o = [
        "b",
        "r",
        "c"
    ], t = "index";
...
var wh, vh, Qu, el = O(()=>{
    ...
    wh = (i1)=>({
      ...
      `;
        ...
        let a = G(i1.session.backend.glContext.version), u = `
      ${Ih(r)}
      ${_h(n)}
      ${le()}
...
var ui, rl = O(()=>{
    ...
    j();
    ui = (i1, e)=>{
        let o = e.shape, t = G(i1.session.backend.glContext.version), r = `
...
function Sh(i1, e) {
    if (i1 === 1) return "rc";
    let o = "";
    for(let t = 0; t < i1; t++)o += e[t], t < i1 - 1 && (o += ",");
    return o;
}
var nl, Oh, ol, il = O(()=>{
    "use strict";
    ...
    nl = {
        ...
        let o = e.dims.length, t = cr("rc", o), r = t.slice(-2), n = kt(o), s = le(), u = e.dims.length === 0 ? "" : Sh(o, t), l = o <= 1 ? "rc" : `vec2(${r.join(",")})`, f = G(i1.session.backend.glContext.version), p = `
    ${s}
    void main() {
...
var Cr, al, li, sl = O(()=>{
    ...
    Cr = (i1, e, o)=>{
        ...
        let n = !!(r && r.isPacked), [s, a] = i1.computeTextureWH(n && t || e, r), u = e.length, l = e.slice(0);
        if (u === 0 && (l = [
            1
        ]), o === 1) t = e;
        else if (n) {
...
var Ph, Pn, ll = O(()=>{
    ...
    j();
    Ph = (i1, e)=>{
        let o = e.map((r)=>`${r.unpackedShape.join(",")};${r.width}x${r.height}`).join("_"), t = i1.name;
        return i1.cacheHint && (t += "[" + i1.cacheHint + "]"), t += ":" + o, t;
    }, Pn = class {
        constructor(e){
            this.session = e;
            ...
            if (!t) {
                ...
                if (o === 4) {
                    ...
                    if (a.length === 4) {
                        let u = [
                            a[0],
                            Math.ceil(a[1] * a[2] * a[3] / 4)
                        ], l = Cr(this.session.layoutStrategy, u, o), f = e.numberData;
                        if (a[1] * a[2] * a[3] % 4 !== 0) {
                ...
                if (o === 2) {
                    let n = li(this.session.layoutStrategy, e.dims, 1, [], {
                        reverseWH: !0
        ...
        reshapeUnpacked(e, o) {
            let t = this.getOrCreateTextureData(e, 0), r = {
                channels: t.channels,
                height: t.height,
                width: t.width,
                shape: o.length !== 0 ? o : [
        ...
        reshapePacked(e, o) {
            ...
            let r = si(e.dims), n = si(o), s = this.reshapePacked(e, r), a = this.run(Qu(this, s, n), [
                s
            ]);
        ...
        pack(e) {
            return this.executeProgram(Yu(this, e.tensor), [
                e.tensor
            ]);
        }
        unpack(e) {
            return this.executeProgram(ol(this, e.tensor), [
                e.tensor
            ]);
        }
    };
...
var fl, cl, pl, Eh, Dh, dl = O(()=>{
    ...
    fl = {
        ...
        let e = i1.attributes.getFloat("epsilon", 1e-5), o = i1.attributes.getFloat("momentum", .9), t = i1.attributes.getInt("spatial", 1);
        return W({
            epsilon: e,
            momentum: o,
            spatial: t
        ...
        let t = G(i1.session.backend.glContext.version), r = e[0].dims.length, [n, s] = i1.calculateTextureWidthAndHeight(e[1].dims, 0), a = `
  float process(int[${r}] indices) {
    ...
    return scale * ( (_A(indices) - mean) / sqrt(variance + float(${o.epsilon})) ) + b;
        ...
        if (!i1 || i1.length !== 5) throw new Error("BatchNormalization requires 5 inputs.");
        let e = i1[0], o = i1[1], t = i1[2], r = i1[3], n = i1[4];
...
var En, Wt, k, Nr, Dn, be = O(()=>{
    ...
    En = class {
        ...
        static returnOrderedNodes(e) {
            ...
            let o = new Set, t = new Set, r = new Array;
...
function $h() {
    ...
    return {
        body: `
  float ${i1}(float a, float b) {
    return a + b;
  }
  vec4 ${i1}(vec4 v1, vec4 v2) {
    return v1 + v2;
  }
  `,
        name: i1,
...
var Ht, Hh, hl, ml, bl, gl, yl, xl, Tl, wl, vl, Il, _l, Ol, Sl = O(()=>{
    ...
    st();
    j();
    Ht = (i1, e, o, t = e[0].type, r)=>{
        let n = i1.session.pack ? 2 : 0;
        return {
            name: o.name,
            inputNames: [
                "A",
    ...
    }, Hh = (i1, e, o, t = e[0].type)=>{
        let r = i1.session.pack ? 2 : 0, n = !B.areEqual(e[0].dims, e[1].dims), s = e[0].dims, a = i1.session.pack;
        if (n) {
            let f = $t.calcShape(e[0].dims, e[1].dims, !1);
            if (!f) throw new Error("Can't perform binary op on the given tensors");
            s = f;
            let p = s.length, d = e[0].dims.length !== 0 ? e[0].dims.length : 1, y = e[1].dims.length !== 0 ? e[1].dims.length : 1, w = e[0].dims.length !== 0 ? "bcastIndices_A(indices, aindices);" : "aindices[0] = 0;", v = e[1].dims.length !== 0 ? "bcastIndices_B(indices, bindices);" : "bindices[0] = 0;", S = G(i1.session.backend.glContext.version), L = a ? `
      ${o.body}
      void main() {
      ...
      float process(int indices[${p}]) {
        ...
        let u = G(i1.session.backend.glContext.version), l = `
    ${o.body}
    void main() {
    ...
    `;
        return {
            ...
            i1.run(Ht(i1, e, Gh(), "bool"), e)
        ], bl = (i1, e)=>[
            i1.run(Ht(i1, e, kh()), e)
        ], gl = (i1, e)=>[
            i1.run(Ht(i1, e, Ch(), "bool"), e)
        ], yl = (i1, e)=>[
            i1.run(Ht(i1, e, Nh(), "bool"), e)
        ], xl = (i1, e)=>[
            i1.run(Ht(i1, e, Rh(), "bool"), e)
        ], Tl = (i1, e)=>[
            i1.run(Ht(i1, e, Bh()), e)
        ], wl = (i1, e)=>[
            i1.run(Ht(i1, e, Mh(), "bool"), e)
        ], vl = (i1, e)=>[
            i1.run(Ht(i1, e, Vh()), e)
        ], Il = (i1, e)=>[
            i1.run(Ht(i1, e, zh()), e)
...
var Al, Pl, jh, El = O(()=>{
    ...
    Al = (i1, e, o)=>(jh(e), [
            i1.cast(e[0], o)
        ]), Pl = (i1)=>_t.tensorDataTypeFromProto(i1.attributes.getInt("to")), jh = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("Cast requires 1 input.");
        if (i1[0].type === "string") throw new Error("Invalid input type.");
    };
});
    ...
    Xh = (i1, e)=>({
        ...
        S += `
            return getChannel(
              getX${L}(${Ln(p, y, A)}),
              vec2(${Ln(w, y, A)}));`;
        let P = G(i1.session.backend.glContext.version), M = `
          ${l}
        ...
        return {
            ...t,
            get: ()=>Kh(i1, t, e, o.axis)
        };
    }, Ln = (i1, e, o)=>{
        let t = i1.indexOf(e);
        return i1.map((n, s)=>s === t ? `${n} - ${o}` : n).join();
    };
});
var $l, Jh, Yh, Zh, kl, Qh, tm, em, Bl, rm, Fl = O(()=>{
    ...
    j();
    Ll();
    $l = (i1, e, o)=>(rm(e), i1.session.pack && e[0].dims.length > 1 ? [
            i1.run(Dl(i1, e, o), e)
        ] : [
            i1.run(Zh(i1, e, o), e)
        ]), Jh = (i1, e)=>({
        ...
        return {
            ...t,
            get: ()=>Yh(i1, t, e, o.axis)
        };
    }, kl = (i1)=>`int getTextureWhereDataResides(int index) {
      ${i1.map((o, t)=>`if(index<${o}) {return ${t};}
`).join("")}
    }`, Qh = (i1)=>kl(i1), tm = (i1, e)=>{
        let o = [
            `float fetchDataFromCorrectTexture(int textureIndex, int indices[${e}]) {`
        ];
        for(let t = 0; t < i1; ++t)t === 0 ? o.push(`	if (textureIndex == ${t}) { return _X${t}(indices); }`) : t === i1 - 1 ? o.push(`	else { return _X${t}(indices); }`) : o.push(`	else if (textureIndex == ${t}) { return _X${t}(indices); }`);
...
`);
        ...
        for(let o = 0; o < i1.length; ++o)o === 0 ? e.push(`	if (index == ${o}) { return ${i1[o]}; }`) : o === i1.length - 1 ? e.push(`	else { return ${i1[o]}; }`) : e.push(`	else if (index == ${o}) { return ${i1[o]}; }`);
        return e.push("	}"), e.join(`
`);
    }, Bl = (i1)=>W({
            axis: i1.attributes.getInt("axis")
        }), rm = (i1)=>{
        if (!i1 || i1.length < 1) throw new Error("too few inputs");
        let e = i1[0].type, o = i1[0].dims.length;
...
var wm, dt, Cl, Nl, Rl, Gl, hi, Ml, Ul, vm, Vl, zl, Wl, Hl, ql, jl, mi, Xl, Kl, Jl, Yl, Zl, Ql, tf, ef, rf, nf, of, bi = O(()=>{
    ...
    j();
    wm = (i1, e, o, t)=>{
        let r = i1.session.pack ? 2 : 0, n = G(i1.session.backend.glContext.version);
        return {
            ...e,
            output: {
                dims: o.dims,
     ...
     `,
        ...
        return {
            ...
            i1.run(dt(i1, e[0], nm()), e)
        ], Nl = (i1, e)=>[
            i1.run(dt(i1, e[0], om()), e)
        ], Rl = (i1, e)=>[
            i1.run(dt(i1, e[0], im()), e)
        ], Gl = (i1, e)=>[
            i1.run(dt(i1, e[0], am()), e)
        ], hi = (i1, e, o)=>[
            i1.run(dt(i1, e[0], ci(o.min, o.max), o.cacheKey), e)
        ], Ml = (i1)=>W({
            min: i1.attributes.getFloat("min", Ue),
            max: i1.attributes.getFloat("max", Ve)
        }), Ul = (i1, e)=>{
        let o = vm(i1, e);
        return hi(i1, [
            e[0]
        ...
        if (e.length >= 3 && (!i1.session.isInitializer(e[1].dataId) || !i1.session.isInitializer(e[2].dataId))) throw new Error("dynamic clip attributes are not allowed");
        ...
        return W({
            ...
            i1.run(dt(i1, e[0], sm()), e)
        ], zl = (i1, e)=>[
            i1.run(dt(i1, e[0], um()), e)
        ], Wl = (i1, e, o)=>[
            i1.run(dt(i1, e[0], lm(o.alpha), o.cacheKey), e)
        ], Hl = (i1)=>W({
            alpha: i1.attributes.getFloat("alpha", 1)
        }), ql = (i1, e)=>[
            i1.run(dt(i1, e[0], fm()), e)
        ], jl = (i1, e)=>[
            i1.run(dt(i1, e[0], cm()), e)
        ], mi = (i1, e)=>[
            i1.run(dt(i1, e[0], pm()), e)
        ], Xl = (i1, e, o)=>[
            i1.run(dt(i1, e[0], dm(o.alpha), o.cacheKey), e)
        ], Kl = (i1)=>W({
            alpha: i1.attributes.getFloat("alpha", .01)
        }), Jl = (i1, e)=>[
            i1.run(dt(i1, e[0], hm()), e)
        ], Yl = (i1, e)=>[
            i1.run(dt(i1, e[0], mm()), e)
        ], Zl = (i1, e)=>[
            i1.run(dt(i1, e[0], bm()), e)
        ], Ql = (i1, e)=>[
            i1.run(dt(i1, e[0], pi()), e)
        ], tf = (i1, e)=>[
            i1.run(dt(i1, e[0], di()), e)
        ], ef = (i1, e)=>[
            i1.run(dt(i1, e[0], gm()), e)
        ], rf = (i1, e)=>[
            i1.run(dt(i1, e[0], ym()), e)
        ], nf = (i1, e)=>[
            i1.run(dt(i1, e[0], xm()), e)
        ], of = (i1, e)=>[
            i1.run(dt(i1, e[0], Tm()), e)
        ];
});
function fe(i1) {
    let e;
    switch(i1.activation){
        case "Relu":
            e = pi();
            break;
        case "Sigmoid":
...
var pr, He = O(()=>{
    ...
    bi();
    pr = (i1)=>{
        let e = i1.getString("activation", "");
        if (e === "Clip") {
            let [o, t] = i1.getFloats("activation_params", [
                Ue,
                Ve
            ]);
            return {
...
var _m, Om, af, sf = O(()=>{
    ...
    _m = (i1, e)=>({
        ...
        let l = dr(s, a, t.dilations, t.pads, t.strides), f = G(i1.session.backend.glContext.version), { activationFunction: p, applyActivation: d } = fe(t), y = `
...
var Sm, Am, uf, lf = O(()=>{
    ...
    Sm = (i1)=>({
        ...
        let s = o.dims, a = t.dims, u = 2, l = 3, f = r.length, p = [
            a[1] * a[2] * a[3],
            r[2] * r[3]
        ], d = a[2] * a[3], y = le(), w = G(i1.session.backend.glContext.version), v = "";
...
function Em(i1, e, o) {
    let t = e[0].dims, r = e[1].dims, n = $t.calcShape(t, r, !0);
    if (!n) throw new Error("Can't use matmul on the given tensors");
    let s = kt(n.length), a = ee(), { activationFunction: u, applyActivation: l } = fe(o), f = e.length > 2, p = f ? "value += getBiasForMatmul();" : "", d = f ? `${yi(s, a, e[2].dims, n, !1)}` : "", y = n.length, w = t.length, v = r.length, S = t[t.length - 1], L = `
    ${u}
    ${d}
...
function gi(i1, e) {
    let o = Pm(i1.length > 2, e.activationCacheKey);
    return {
        ...o,
        get: ()=>Em(o, i1, e)
    };
}
function yi(i1, e, o, t, r) {
...
var ff, cf, Pm, Dm, kn = O(()=>{
    ...
    He();
    xi();
    ff = (i1, e, o)=>(Dm(e), i1.session.pack ? [
            i1.run(Bn(i1, e, o), e)
        ] : [
            i1.run(gi(e, o), e)
        ]), cf = (i1)=>pr(i1.attributes), Pm = (i1, e)=>({
            name: "MatMul",
            inputNames: i1 ? [
                "A",
                "B",
    ...
    Dm = (i1)=>{
        if (!i1 || i1.length !== 2) throw new Error("MatMul requires 2 inputs.");
        if (i1[0].dims[i1[0].dims.length - 1] !== i1[1].dims[i1[1].dims.length - 2]) throw new Error("shared dimension does not match.");
        if (i1[0].type !== "float32" && i1[0].type !== "float64" || i1[1].type !== "float32" && i1[1].type !== "float64") throw new Error("inputs should be float type");
        if (i1[0].type !== i1[1].type) throw new Error("inputs types should match");
    };
});
function km(i1, e, o, t) {
...
function Bm(i1, e) {
    let o = "";
    for(let t = 0; t < e - 2; t++)o += `rc.${i1[t]}, `;
    return o += `rc.${i1[e - 2]}, i*2`, o;
}
function Fm(i1, e) {
    let o = "";
    for(let t = 0; t < e - 2; t++)o += `rc.${i1[t]}, `;
    return o += `i*2, rc.${i1[e - 1]}`, o;
}
var Lm, $m, Bn, xi = O(()=>{
    "use strict";
    Y();
    ...
    Lm = (i1, e)=>({
        ...
        let r = o.length > 2, n = r ? "value += getBiasForMatmul();" : "", s = o[0].dims, a = o[1].dims, u = $t.calcShape(s, a, !0), l = !B.areEqual(o[0].dims, o[1].dims);
        if (!u) throw new Error("Can't use matmul on the given tensors");
        let f = s[s.length - 1], p = Math.ceil(f / 2), d = s.length, y = a.length, w = G(i1.session.backend.glContext.version), v = kt(u.length), S = u.length, L = ee(), { activationFunction: A, applyActivation: P } = fe(t), M = r ? `${yi(v, L, o[2].dims, u, !0)}` : "", V = l ? `${km(v, L, o, u)}` : "", ut = l ? "getAAtOutCoordsMatmul(i)" : `getA(${Bm(L, d)})`, xt = l ? "getBAtOutCoordsMatmul(i)" : `getB(${Fm(L, y)})`, et = l ? "" : `${v} rc =
...
var pf, df = O(()=>{
    ...
    xi();
    pf = (i1, e, o)=>{
        let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i1.run(uf(i1, e[0], e[1], n, o), [
            e[0]
        ]), a = i1.reshapePacked(e[1], [
            r[0],
            r[1] * r[2] * r[3]
        ]), u = e.length === 3 ? [
            a,
            ...
            a,
            s
        ], l = i1.run(Bn(i1, u, o), u);
        return i1.reshapePacked(l, n);
    };
});
...
var Rm, Gm, mf, bf = O(()=>{
    ...
    Rm = (i1, e)=>({
        ...
        let n = o[0].dims, s = o[1].dims, a = [
            s[0],
            Math.ceil(n[1] * s[2] * s[3] / 4)
        ], u = Ti(n, s, t), [l, f] = i1.calculateTextureWidthAndHeight(a, 4), p = B.computeStrides(u), [d, y] = i1.calculateTextureWidthAndHeight(u, 4), w = t.length, v = o.length < 3 ? "0.0" : "_B(b)", S = Math.ceil(n[1] * s[2] * s[3] / 4), { activationFunction: L, applyActivation: A } = fe(r), P = G(i1.session.backend.glContext.version), M = `
${L}
...
var dr, vi, Mm, Um, Vm, zm, Ii, Wm, $n = O(()=>{
    ...
    kn();
    dr = (i1, e, o, t, r)=>{
        let n = i1[0], s = i1.slice(2), a = s.length, u = e[0], f = e.slice(2).map((w, v)=>w + (w - 1) * (o[v] - 1)), d = s.map((w, v)=>w + t[v] + t[v + a]).map((w, v)=>Math.floor((w - f[v] + r[v]) / r[v]));
        return [
            n,
            u
        ].concat(...d);
    }, vi = (i1, e, o)=>(Wm(e, o), Mm(i1, e, o)), Mm = (i1, e, o)=>{
        let t = zm(o, e), r = i1.session.pack, n = t.kernelShape[0] === 1 && t.kernelShape[1] === 1;
        return t.group > 1 ? [
            i1.run(af(i1, e, t), e)
        ] : n && r ? [
            Um(i1, e, t)
        ...
        let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i1.reshapeUnpacked(e[0], [
            t[1],
            t[2] * t[3]
        ]), a = i1.reshapeUnpacked(e[1], [
            r[0],
            r[1]
        ]), u = e.length > 2 ? [
            a,
        ...
        return i1.reshapeUnpacked(l, n);
    }, Vm = (i1, e, o)=>{
        let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i1.run(hf(i1, e[0], e[1], n, o), [
            e[0]
        ]), a = e.length === 3 ? [
            s,
            e[1],
        ...
        return i1.run(mf(i1, e, n, o), a);
    }, zm = (i1, e)=>{
        let o = i1.kernelShape.slice();
        if (i1.kernelShape.length === 0) for(let n = 2; n < e[1].dims.length; ++n)o.push(e[1].dims[n]);
        let t = i1.pads.slice();
        Me.adjustPadsBasedOnAutoPad(e[0].dims, i1.strides, i1.dilations, o, t, i1.autoPad);
        let r = Object.assign({}, i1);
        return Object.assign(r, {
            kernelShape: o,
            pads: t,
            cacheKey: i1.cacheKey
        }), r;
    }, Ii = (i1)=>{
        let e = i1.attributes, o = pr(e), t = e.getString("auto_pad", "NOTSET"), r = e.getInts("dilations", [
            1,
            1
        ]), n = e.getInt("group", 1), s = e.getInts("kernel_shape", []), a = e.getInts("pads", [
            0,
            0,
            0,
            0
        ...
        if (!i1 || i1.length !== 2 && i1.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
        if (i1[0].dims.length !== 4 || i1[1].dims.length !== 4) throw new Error("currently only support 2-dimensional conv");
        let o = i1[0].dims[1], t = i1[1].dims[1] * e.group;
        if (o !== t) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
        if (i1.length === 3 && (i1[2].dims.length !== 1 || i1[1].dims[0] !== i1[2].dims[0])) throw new Error("invalid bias");
        let r = i1[0].dims.length - 2;
        ...
        if (e.kernelShape.length !== 0 && e.kernelShape.length !== i1[1].dims.length - 2) throw new Error("invalid kernel shape");
        if (i1[0].type !== "float32" || i1[1].type !== "float32") throw new Error("Conv input(X,W) should be float tensor");
        if (i1.length === 3 && i1[2].type !== "float32") throw new Error("Conv input(bias) should be float tensor");
    };
});
var Hm, qm, jm, gf, Xm, Km, Jm, Ym, Zm, Qm, yf, tb, xf = O(()=>{
    ...
    j();
    He();
    Hm = (i1, e, o, t, r, n)=>(i1 - 1) * e + o + (t - 1) * r + 1 - n, qm = (i1, e, o, t, r)=>{
        let n = Math.floor(i1 / 2);
        e === "SAME_UPPER" ? (o[t] = n, o[r] = i1 - n) : e === "SAME_LOWER" && (o[t] = i1 - n, o[r] = n);
    }, jm = (i1, e, o, t, r, n, s, a)=>{
        let u = i1.length - 2, l = a.length === 0;
        for(let f = 0; f < u; ++f){
            let p = l ? i1[f + 2] * n[f] : a[f], d = Hm(i1[f + 2], n[f], r[f], e[f], o[f], p);
            qm(d, t, r, f, f + u), l && a.push(n[f] * (i1[f + 2] - 1) + s[f] + (e[f] - 1) * o[f] + 1 - r[f] - r[f + u]);
        }
    }, gf = (i1, e, o)=>(tb(e, o), Xm(i1, e, o)), Xm = (i1, e, o)=>{
        let t = Qm(o, e);
        return [
            Zm(i1, e, t)
        ];
        ...
        let n = e.length > 2 ? "getB(output_channel)" : "0.0", s = e[0].dims, a = e[1].dims, u = a[1], l = a[0] / t.group, f = [
            e[0].dims[0],
            e[1].dims[1] * t.group,
            ...t.outputShape
        ], p = G(i1.session.backend.glContext.version), { activationFunction: d, applyActivation: y } = fe(t), w = `
  const ivec2 strides = ivec2(${t.strides[0]}, ${t.strides[1]});
  const ivec2 pads = ivec2(${t.pads[0]}, ${t.pads[1]});
  ${d}
  void main() {
...
`;
    ...
    }, Zm = (i1, e, o)=>i1.run(Ym(i1, e, o), e), Qm = (i1, e)=>{
        let o = i1.kernelShape.slice();
        if (i1.kernelShape.length === 0) for(let a = 2; a < e[1].dims.length; ++a)o.push(e[1].dims[a]);
        let t = i1.pads.slice(), r = i1.outputShape.slice(), n = e[0].dims;
        jm(n, o, i1.dilations, i1.autoPad, t, i1.strides, i1.outputPadding, r);
        let s = Object.assign({}, i1);
        ...
        let e = i1.attributes, o = pr(e), t = e.getString("auto_pad", "NOTSET"), r = e.getInts("dilations", [
            1,
            1
        ]), n = e.getInt("group", 1), s = e.getInts("kernel_shape", []), a = e.getInts("output_padding", [
            0,
            0
        ]), u = e.getInts("output_shape", []), l = e.getInts("pads", [
            0,
            0,
            0,
            0
        ...
        if (!i1 || i1.length !== 2 && i1.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
        if (i1[0].dims.length !== 4 || i1[1].dims.length !== 4) throw new Error("currently only support 2-dimensional conv");
        let o = i1[0].dims[1], t = i1[1].dims[0];
        if (o !== t) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
        let r = i1[1].dims[1] * e.group;
        if (i1.length === 3 && (i1[2].dims.length !== 1 || i1[2].dims[0] !== r)) throw new Error("invalid bias");
        let n = i1[0].dims.length - 2;
        ...
        if (e.kernelShape.length !== 0 && e.kernelShape.length !== i1[1].dims.length - 2) throw new Error("invalid kernel shape");
        if (e.outputShape.length !== 0 && e.outputShape.length !== i1[0].dims.length - 2) throw new Error("invalid output shape");
        if (i1[0].type !== "float32" || i1[1].type !== "float32") throw new Error("ConvTranspose input(X,W) should be float tensor");
        if (i1.length === 3 && i1[2].type !== "float32") throw new Error("ConvTranspose input(bias) should be float tensor");
    };
});
var Tf, qe, wf, eb, vf, rb, nb, ob, Fn = O(()=>{
    ...
    Tf = {
        ...
        inputTypes: [
            ...
            i1.run({
                ...Tf,
                cacheHint: o.cacheKey,
                get: ()=>eb(i1, e[0], o.perm)
            }, e)
        ]), wf = (i1)=>W({
            perm: i1.attributes.getInts("perm", [])
        }), eb = (i1, e, o)=>{
        let t = e.dims;
        o = vf(t, o);
    ...
    }, vf = (i1, e)=>(e && e.length !== i1.length && (e = [
            ...i1.keys()
        ].reverse()), e), rb = (i1, e)=>(e = vf(i1, e), B.sortBasedOnPerm(i1, e)), nb = (i1, e, o)=>{
        let t = [];
        t.push(`void ${i1}(out int a[${o}], int src[${o}]) {`);
        for(let r = 0; r < o; ++r)t.push(`	a[${e[r]}]=src[${r}];`);
        return t.push("	}"), t.join(`
`);
    }, ob = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("Transpose requires 1 input.");
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("input should be float tensor");
    };
});
var If, _f, ib, Of = O(()=>{
    "use strict";
    ...
    If = (i1, e, o)=>{
        ib(e);
        let t = o.blocksize, r = t * t, n = o.mode === "DCR" ? [
            0,
            3,
            4,
            1,
        ...
        return [
            i1.reshapeUnpacked(l, f)
        ];
    }, _f = (i1)=>{
        let e = i1.attributes.getInt("blocksize");
        if (e < 1) throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);
        let o = i1.attributes.getString("mode", "DCR");
        ...
        if (i1.length !== 1) throw new Error(`DepthToSpace expect 1 inputs, but got ${i1.length}`);
        if (i1[0].type === "string" || i1[0].dims.length !== 4) throw new TypeError("DepthToSpace input should be a 4-D numeric tensor");
    };
});
var Sf, Af, ab, Pf = O(()=>{
    "use strict";
    ...
    Sf = (i1, e, o)=>{
        ...
        return [
            i1.reshapeUnpacked(e[0], t)
        ];
    }, Af = (i1)=>i1.attributes.getInt("axis", 1), ab = (i1, e)=>{
        if (!i1 || i1.length !== 1) throw new Error("Flatten requires 1 input.");
        let o = i1[0].dims.length;
        if (o === 0) throw new Error("scalar tensor is not supported.");
        if (e < -o || e > o) throw new Error("Invalid axis");
        if (i1[0].type === "string") throw new Error("string tensor is not supported.");
    };
});
var Ae, Rr = O(()=>{
    "use strict";
...
var Ef, Df, sb, ub, lb, fb, Lf = O(()=>{
    ...
    Y();
    j();
    Ef = (i1, e, o)=>(fb(e, o.axis), [
            i1.run(lb(i1, e, o), e)
        ]), Df = (i1)=>W({
            axis: i1.attributes.getInt("axis", 0)
        }), sb = {
        name: "Gather",
        inputNames: [
            "A",
      ...
      float process(int outputIdx[${u}]) {
        ...
        return {
            ...t,
            get: ()=>ub(i1, t, e, o.axis)
        };
    }, fb = (i1, e)=>{
        if (!i1 || i1.length !== 2) throw new Error("Gather requires 2 inputs.");
        let o = i1[0].dims.length;
        if (o < 1) throw new Error("Invalid input shape.");
        if (e < -o || e > o - 1) throw new Error("Invalid axis.");
        if (Ae.indexOf(i1[0].type) === -1) throw new Error("Invaid input type.");
        if (i1[1].type !== "int32" && i1[1].type !== "int16") throw new Error("Invaid input type.");
    };
});
var _i, $f, kf, Bf, cb, pb, db, Ff = O(()=>{
    ...
    _i = (i1, e, o)=>(db(e, o), [
        ...
        let o = i1.attributes.getInt("transA", 0) !== 0, t = i1.attributes.getInt("transB", 0) !== 0, r = i1.attributes.getFloat("alpha", 1), n = i1.attributes.getFloat("beta", 1);
        return W({
            transA: o,
            transB: t,
            alpha: r,
    ...
    }, kf = (i1)=>$f(i1, !1), Bf = (i1)=>$f(i1, !0), cb = (i1, e)=>{
        let o = {
            name: "Gemm",
            inputNames: i1.length === 3 ? [
                "A",
                "B",
                "C"
            ] : [
        ...
        let t = e[0].dims.slice(), r = e[1].dims.slice(), [n, s] = _n.getShapeOfGemmResult(t, o.transA, r, o.transB, e.length === 3 ? e[2].dims : void 0), a = [
            n,
            s
        ];
      ...
      float process(int indices[${f}]) {
        ...
        if (!i1) throw new Error("Input is missing");
        if (e.isOptionalC && (i1.length < 2 || i1.length > 3)) throw new Error("Invaid input shape.");
        if (!e.isOptionalC && i1.length !== 3) throw new Error("Gemm requires 3 inputs");
        if (i1.length === 3 && i1[2].dims.length !== 1 && i1[2].dims.length !== 2) throw new Error("Invalid input shape of C");
        if (i1[0].type !== "float32" && i1[0].type !== "float64" || i1[1].type !== "float32" && i1[1].type !== "float64" || i1.length === 3 && i1[2].type !== "float32" && i1[2].type !== "float64") throw new Error("Invalid input type.");
        if (i1[0].type !== i1[1].type || i1.length === 3 && i1[0].type !== i1[2].type) throw new Error("Input types are mismatched");
    };
});
var Cf, Nf, hb, mb, bb, gb, yb, Rf = O(()=>{
    ...
    Cf = (i1, e, o)=>(yb(e), [
        ...
        let e = i1.attributes.getFloat("scale"), o = i1.attributes.getFloats("bias");
        return W({
            scale: e,
            bias: o
        });
      ...
      float process(int indices[${n}]) {
        ...
        let e = [
            `float getBias(float bias[${i1}], int channel) {`
        ];
        for(let o = 0; o < i1; ++o)o === 0 ? e.push(`	if (channel == ${o}) { return bias[${o}]; }`) : o === i1 - 1 ? e.push(`	else { return bias[${o}]; }`) : e.push(`	else if (channel == ${o}) { return bias[${o}]; }`);
        return e.push("	}"), e.join(`
`);
    }, yb = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("ImageScaler requires 1 input.");
        if (i1[0].dims.length !== 4) throw new Error("Invalid input shape.");
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("Invalid input type.");
    };
});
var Mf, Uf, Gf, xb, Tb, wb, vb, Ib, _b, Vf = O(()=>{
    ...
    Mf = (i1, e, o)=>{
        _b(e);
        let t = i1.run(Tb(e[0]), e);
        return [
            i1.run(Ib(i1, e[0], o, t.dims), [
                e[0],
                t,
                e[1],
                e[2]
    ...
    }, Uf = (i1)=>i1.attributes.getFloat("epsilon", 1e-5), Gf = {
        ...
        let o = e.dims.slice(), t = o[1], r = o[2] * o[3], n = [
            o[0],
            t
        ], s = `
      vec4 process(int[2] indices) {
        ...
        let n = G(i1.session.backend.glContext.version), [s, a] = i1.calculateTextureWidthAndHeight(r, 4), [u, l] = [
            s / 4,
            a
        ], f = `
      ...
      float process(int[4] indices) {
        ...
        if (!i1 || i1.length !== 3) throw new Error("InstanceNormalization requires 3 inputs.");
        let e = i1[0], o = i1[1], t = i1[2];
        ...
        if (i1[0].dims.length !== 4) throw new Error("Only support 4-D input shape.");
    };
});
function Ob(i1, e) {
    let o = i1[0].dims[1], t = i1[0].dims.length, r = -Math.floor((e.size - 1) / 2), n = Math.ceil((e.size - 1) / 2), s = `float(${e.alpha}) / float(${e.size})`, a = `float(${e.bias})`, u = `float(${e.beta})`, l = `
...
var zf, Wf, Hf, Ab, qf = O(()=>{
    ...
    zf = (i1, e, o)=>(Ab(e), [
        ...
        let e = i1.attributes.getFloat("alpha", 1e-4), o = i1.attributes.getFloat("beta", .75), t = i1.attributes.getFloat("bias", 1), r = i1.attributes.getInt("size");
        return W({
            alpha: e,
            beta: o,
            bias: t,
    ...
    Ab = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("LRN requires 1 input.");
        if (i1[0].dims.length !== 4) throw new Error('currently only support LRN for input with "NCHW" format');
        if (i1[0].type !== "float32") throw new Error("input should be float type");
    };
});
var Pb, Oi, jf, Xf, Kf, Eb, Db, Lb, $b, kb, Bb, Fb, Cb, Jf = O(()=>{
    ...
    Pb = {
        ...
        let e = i1.attributes.getString("mode", "constant"), o = i1.attributes.getFloat("value", 0), t = i1.attributes.getInts("pads");
        return W({
            mode: e,
            value: o,
            pads: t
    ...
    }, Kf = (i1)=>i1.attributes.getString("mode", "constant"), Eb = (i1, e, o)=>{
        if (!i1.session.isInitializer(e[1].dataId) || e.length >= 3 && !i1.session.isInitializer(e[2].dataId)) throw new Error("dynamic pad attributes are not allowed");
      ...
      float process(int[${r}] indices) {
        ...
        if (!i1 || i1.length !== 1) throw new Error("Pad requires 1 input");
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("Invalid input type.");
    }, $b = (i1)=>{
        if (!i1 || i1.length !== 2 && i1.length !== 3) throw new Error("Pad requires 2 or 3 inputs");
        if (i1[1].type !== "int32") throw new Error("Invalid input type.");
        if (i1.length >= 3 && i1[2].type === "string") throw new Error("Invalid input type.");
    }, kb = (i1, e, o)=>{
        let t = G(i1.session.backend.glContext.version), [r, n] = i1.calculateTextureWidthAndHeight(e.dims, 0), s = B.computeStrides(e.dims);
        switch(o.mode){
            case "constant":
      ...
      float padA(int m[${a}]) {
        ...
        float value = getColorAsFloat(${i1.texture2D}(A, coords));
        return value;
      }
      `;
    }, Fb = (i1, e, o, t, r, n)=>{
...
var Zf, Qf, tc, ec, rc, nc, oc, ic, ac, Nb, Yf, sc, Nn, uc, Cn, Rb, lc = O(()=>{
    ...
    Zf = (i1, e, o)=>{
        ...
        let e = i1.attributes.getString("auto_pad", "NOTSET"), o = i1.attributes.getInt("ceil_mode", 0), t = i1.attributes.getInt("count_include_pad", 0) !== 0, r = i1.attributes.getInts("kernel_shape"), n = i1.attributes.getInts("strides", []), s = i1.attributes.getInts("pads", []);
        ...
        let [r, n] = ac(i1, t, o), s = B.size(r.kernelShape), a = "value += _X(x);", u = "";
        r.countIncludePad ? u += `value /= float(${s});` : u += `value /= float(${s} - pad);`;
        let f = `
        ${uc(i1[0].dims, r, a, u, "0.0")}
      `;
        return {
            ...e,
            output: {
        ...
        let e = i1.attributes.getInt("count_include_pad", 0) !== 0;
        return W({
            autoPad: "",
            ceilMode: 0,
            countIncludePad: e,
        ...
        let e = i1.attributes.getString("auto_pad", "NOTSET"), o = i1.attributes.getInt("ceil_mode", 0), t = i1.attributes.getInts("kernel_shape"), r = i1.attributes.getInts("strides", []), n = i1.attributes.getInts("pads", []), s = i1.attributes.getInt("storage_order", 0), a = i1.attributes.getInts("dilations", []);
    ...
    `;
        ...
        let t = i1[0].dims.slice(), r = Object.hasOwnProperty.call(e, "dilations"), n = e.kernelShape.slice(), s = e.strides.slice(), a = r ? e.dilations.slice() : [], u = e.pads.slice();
        ...
        if (!i1 || i1.length !== 1) throw new Error("Pool ops requires 1 input.");
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("Invalid input type.");
    }, uc = (i1, e, o, t, r)=>{
        let n = i1.length;
        if (e.kernelShape.length <= 2) {
            let s = e.kernelShape[e.kernelShape.length - 1], a = e.strides[e.strides.length - 1], u = e.pads[e.pads.length / 2 - 1], l = e.pads[e.pads.length - 1], f = i1[n - 1], p = "", d = "", y = "";
            if (u + l !== 0 ? p = `
          for (int i = 0; i < ${s}; i++) {
          ...
          for (int i = 0; i < ${s}; i++) {
            ...
            ${o}
                ...
                let v = e.kernelShape[e.kernelShape.length - 2], S = e.strides[e.strides.length - 2], L = e.pads[e.pads.length / 2 - 2], A = e.pads[e.pads.length - 2], P = i1[n - 2];
                L + A !== 0 ? d = `
            for (int j = 0; j < ${v}; j++) {
      ...
      `;
            ...
            let s = B.size(e.kernelShape), a = B.computeStrides(e.kernelShape), u = a.length, l = e.pads.length, f = Rb(u), p = Cn(i1, "inputDims"), d = Cn(e.pads, "pads"), y = Cn(a, "kernelStrides"), w = Cn(e.strides, "strides"), v = e.pads.reduce((A, P)=>A + P), S = "";
            return v ? S = `
      ...
      `;
        ...
        let o = "";
        for(let t = 0; t < i1.length; t++)o += `
      ${e}[${t}] = ${i1[t]};
    `;
        return o;
    }, Rb = (i1)=>`
  void offsetToIndices(int offset, int[${i1}] strides, out int[${i1}] indices) {
    if (${i1} == 0) {
      return;
    }
...
var je, Pe, Gb, Mb, fc, cc, pc, dc, hc, mc, bc, gc = O(()=>{
    ...
    je = (i1, e, o, t, r)=>{
        ...
        let e = i1.attributes.getInts("axes", []), o = i1.attributes.getInt("keepdims", 1) === 1;
        return W({
            axes: e,
            keepDims: o
        });
...
`)}
        ...
        if (!i1 || i1.length !== 1) throw new Error("Reduce op requires 1 input.");
        if (Ae.indexOf(i1[0].type) === -1) throw new Error("Invalid input type.");
    }, fc = (i1, e, o)=>je(i1, e, o, "ReduceSum", ()=>[
                "value = 0.0;",
                "value += _A(inputIdx);",
                ""
            ]), cc = (i1, e, o)=>je(i1, e, o, "ReduceMean", (r, n)=>{
            let s = 1;
        ...
        }), pc = (i1, e, o)=>je(i1, e, o, "ReduceMax", (r, n)=>{
            let s = [];
...
value = _A(inputIdx);`,
        ...
        }), dc = (i1, e, o)=>je(i1, e, o, "ReduceMin", (r, n)=>{
            let s = [];
            for(let a = 0; a < r[0].dims.length; a++)(n.indexOf(a) >= 0 || n.length === 0) && s.push(`inputIdx[${a}] = 0;`);
            return [
                `${s.join(`
...
value = _A(inputIdx);`,
        ...
        }), hc = (i1, e, o)=>je(i1, e, o, "ReduceProd", ()=>[
                "value = 1.0;",
                "value *= _A(inputIdx);",
                ""
            ]), mc = (i1, e, o)=>je(i1, e, o, "ReduceLogSum", ()=>[
                "value = 0.0;",
                "value += _A(inputIdx);",
                "value = log(value);"
            ]), bc = (i1, e, o)=>je(i1, e, o, "ReduceLogSumSquare", ()=>[
                "float t; value = 0.0;",
...
var yc, xc = O(()=>{
    ...
    yc = (i1, e)=>{
        ...
        return i1.session.pack ? [
            i1.reshapePacked(e[0], o)
        ] : [
            i1.reshapeUnpacked(e[0], o)
        ];
    };
});
var Tc, Si, wc, vc, Gr, Ub, Ai, Rn, Pi = O(()=>{
    ...
    Tc = {
        ...
        ]), wc = (i1)=>Gr(i1, 7), vc = (i1)=>Gr(i1, 9), Gr = (i1, e)=>{
        let o = e >= 10, t = i1.attributes.getString("mode", "nearest");
        if (t !== "nearest" && t !== "linear" && (e < 11 || t !== "cubic")) throw new Error(`unrecognized mode: ${t}`);
        let r = [];
        e < 9 && (r = i1.attributes.getFloats("scales"), Rn(r, t, o));
        let n = i1.attributes.getFloat("extrapolation_value", 0), s = e > 10 ? i1.attributes.getString("coordinate_transformation_mode", "half_pixel") : "asymmetric";
        if ([
            "asymmetric",
            "pytorch_half_pixel",
            ...
            "tf_crop_and_resize",
            "half_pixel"
        ].indexOf(s) === -1) throw new Error(`coordinate_transform_mode '${s}' is not supported`);
        let a = s === "tf_crop_and_resize", u = a, l = t === "nearest" && e >= 11 ? i1.attributes.getString("nearest_mode", "round_prefer_floor") : "";
        if ([
            "round_prefer_floor",
            "round_prefer_ceil",
            "floor",
            "ceil",
            ""
        ].indexOf(l) === -1) throw new Error(`nearest_mode '${l}' is not supported`);
        let f = i1.attributes.getFloat("cubic_coeff_a", -.75), p = i1.attributes.getInt("exclude_outside", 0) !== 0;
        if (p && t !== "cubic") throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");
        let d = e < 11 ? !0 : t === "nearest" && s === "asymmetric" && l === "floor", y = 0, w = 0, v = 0;
        return e > 10 ? i1.inputs.length > 2 ? (y = 1, w = 2, v = 3) : (w = 1, v = 2) : e === 9 && (w = 1), W({
            opset: e,
            isResize: o,
            mode: t,
            scales: r,
        ...
        let t = G(i1.session.backend.glContext.version), [r, n] = i1.calculateTextureWidthAndHeight(e[0].dims, 0), s = e[0].dims.map((v, S)=>Math.floor(v * o.scales[S])), [a, u] = i1.calculateTextureWidthAndHeight(s, 0), l = s.length, f = new Array(l), p = new Array(l), d = `
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
        ...
        if (!i1 || e.opset < 9 && i1.length !== 1 || e.opset >= 9 && e.opset < 11 && i1.length !== 2 || e.opset >= 11 && i1.length < 2) throw new Error("invalid inputs.");
        if (e.scales.length > 0 && i1[0].dims.length !== e.scales.length) throw new Error("Invalid input shape.");
        if (i1[0].type === "string") throw new Error("Invalid input tensor types.");
    }, Rn = (i1, e, o)=>{
        if (o) {
            for (let t of i1)if (t <= 0) throw new Error("Scale value should be greater than 0.");
        } else for (let t of i1)if (t < 1) throw new Error("Scale value should be greater than or equal to 1.");
        if ((e === "linear" || e === "cubic") && i1.length !== 2 && (i1.length !== 4 || i1[0] !== 1 || i1[1] !== 1)) throw new Error(`'Linear' mode and 'Cubic' mode only support 2-D inputs ('Bilinear', 'Bicubic')         or 4-D inputs with the corresponding outermost 2 scale values being 1         in the ${o ? "Resize" : "Upsample"} opeartor.`);
    };
});
var Ei, Di, Ic, _c, Vb, zb, Wb, Hb, Oc = O(()=>{
    ...
    Ei = {
        ...
        ]), Ic = (i1)=>Gr(i1, 10), _c = (i1)=>Gr(i1, 11), Vb = (i1, e, o)=>{
        let t = G(i1.session.backend.glContext.version), [r, n] = zb(e, o);
        if (r.every((P)=>P === 1) && o.coordinateTransformMode !== "tf_crop_and_resize") return {
            ...Ei,
            output: {
                dims: n,
                type: e[0].type,
        ...
        let t = i1[0].dims, r = e.scales, n;
        if (r.length === 0) {
            let a = i1[e.scalesInputIdx];
            if (a && a.size !== 0) {
                if (i1[e.sizesInputIdx]) throw new Error("Only one of scales or sizes must be provided as input.");
                r = Wb(a, e.mode, e.isResize);
            } else {
                let u = i1[e.sizesInputIdx];
        ...
        } else if (i1[e.sizesInputIdx]) throw new Error("Only one of scales or sizes must be provided as input.");
        ...
        let t = Array.from(i1.floatData);
        return Rn(t, e, o), t;
    }, Hb = (i1, e, o, t)=>{
        let r = e.length, n = new Array(r);
        for(let s = 0, a = r; s < a; s++)if (e[s] === 0) {
            if (i1[s] !== 0) throw new Error("Input dim is zero but required output dim is non-zero.");
            n[s] = 1;
        } else n[s] = i1[s] / e[s];
        return Rn(n, o, t), n;
    };
...
var Sc, qb, Ac = O(()=>{
    ...
    Sc = (i1, e)=>(qb(e), [
        ...
        if (!i1 || i1.length !== 1) throw new Error("Shape requires 1 input.");
    };
});
var Li, Pc, Ec, Dc, jb, Lc, Xb, Kb, $c = O(()=>{
    ...
    Li = {
        ...
        let e = i1.attributes.getInts("starts"), o = i1.attributes.getInts("ends"), t = i1.attributes.getInts("axes", []);
        return W({
            starts: e,
            ends: o,
            axes: t
      ...
      `)}
        ...
        if (!i1 || i1.length !== 1) throw new Error("Slice requires 1 input.");
        if (Ae.indexOf(i1[0].type) === -1) throw new Error("Invalid input type.");
    }, Lc = (i1, e)=>{
        Kb(e);
        let o = Xb(i1, e);
        ...
        if (!i1.session.isInitializer(e[1].dataId) || !i1.session.isInitializer(e[2].dataId) || e.length >= 4 && !i1.session.isInitializer(e[3].dataId) || e.length >= 5 && !i1.session.isInitializer(e[4].dataId)) throw new Error("dynamic slice attributes are not allowed");
        ...
        if (!i1 || i1.length < 3 || i1.length > 5) throw new Error("Invalid input number.");
        if (i1[1].type !== "int32" || i1[1].dims.length !== 1) throw new Error("Invalid input type.");
        if (i1[2].type !== "int32" || i1[2].dims.length !== 1) throw new Error("Invalid input type.");
        if (i1.length >= 4 && (i1[3].type !== "int32" || i1[3].dims.length !== 1)) throw new Error("Invalid input type.");
        if (i1.length >= 5 && (i1[4].type !== "int32" || i1[4].dims.length !== 1)) throw new Error("Invalid input type.");
    };
});
var kc, Bc, Fc, Cc, Nc, Rc, Gc, Mc, Jb, Yb, Zb, Uc, Vc = O(()=>{
    ...
    kc = {
        ...
        return Mc(i1, e, o, n, s);
    }, Nc = (i1)=>W({
            axis: i1.attributes.getInt("axis", 1)
        }), Rc = (i1)=>W({
            axis: i1.attributes.getInt("axis", -1)
        }), Gc = (i1, e, o)=>{
        Uc(e);
        ...
        s && (u = Array.from({
            length: n
        }).map((w, v)=>v), u[r] = n - 1, u[n - 1] = r, u.map((w)=>a.push(t[w])), f = W({
            perm: u
        }), l = qe(i1, e, f));
        let p = s ? B.sizeToDimension(a, n - 1) : B.sizeToDimension(t, n - 1), d = s ? B.sizeFromDimension(a, n - 1) : B.sizeFromDimension(t, n - 1), y = Mc(i1, s ? l : e, o, p, d);
        return s ? qe(i1, y, f) : y;
    }, Mc = (i1, e, o, t, r)=>{
        let n = Jb(i1, e[0], t, r, [
            t
        ]), s = i1.run({
            ...
            cacheHint: o.cacheKey,
            get: ()=>n
        }, e), a = Yb(i1, e[0], t, r, n.output.dims, [
            t
        ]), u = i1.run({
            ...Bc,
            cacheHint: o.cacheKey,
            ...
            e[0],
            s
        ]), l = Zb(i1, e[0], t, r, n.output.dims, a.output.dims);
        return [
            i1.run({
                ...Fc,
                cacheHint: o.cacheKey,
        ...
        let [n, s] = i1.calculateTextureWidthAndHeight(e.dims, 0), a = r.length;
      ...
      float process(int[${a}] indices) {
        ...
        let [s, a] = i1.calculateTextureWidthAndHeight(e.dims, 0), u = n.length;
        if (o < 1 || t < 1) throw new Error("Logical row count N and feature count D must be greater than or equal to 1");
        ...
        let l = G(i1.session.backend.glContext.version), f = `
      float process(int[${u}] indices) {
        ...
        let [s, a] = i1.calculateTextureWidthAndHeight(e.dims, 0), u = e.dims.length;
        if (o < 1 || t < 1) throw new Error("Logical row count N and feature count D must be greater than or equal to 1");
      ...
      return exp(_A(indices) - _Max(logical_row_index)) / norm_factor;
        ...
        if (!i1 || i1.length !== 1) throw new Error("Softmax requires 1 input.");
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("Invalid input type");
    };
});
var zc, Wc, Hc, Qb, tg, eg, qc = O(()=>{
    ...
    zc = {
        ...
        eg(e);
        let t = B.normalizeAxis(o.axis, e[0].dims.length), r = Qb(i1, e, t, o), n = [];
        for(let s = 0; s < r; ++s)n.push(i1.run({
            ...zc,
        ...
        let e = i1.attributes.getInt("axis", 0), o = i1.attributes.getInts("split", []), t = i1.outputs.length;
        return W({
            axis: e,
            split: o,
            numOutputs: t
    ...
    `;
        ...
        if (!i1 || i1.length !== 1) throw new Error("Split requires one input.");
        if (i1[0].type !== "int8" && i1[0].type !== "uint8" && i1[0].type !== "int16" && i1[0].type !== "uint16" && i1[0].type !== "int32" && i1[0].type !== "uint32" && i1[0].type !== "float32" && i1[0].type !== "float64" && i1[0].type !== "bool") throw new Error("Invalid input type.");
    };
});
var $i, jc, Xc, rg, ng, Kc = O(()=>{
    ...
    $i = (i1, e, o)=>{
        ...
        return [
            ...
            e[0]
        ], Array.from(e[1].integerData))), Xc = (i1)=>i1.attributes.getInts("axes"), rg = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("Squeeze requires 1 input.");
        if (i1[0].type === "string") throw new Error("invalid input tensor types.");
    }, ng = (i1)=>{
        if (!i1 || i1.length !== 2) throw new Error("Squeeze requires 2 inputs.");
        if (i1[1].type !== "int32") throw new Error("Invalid input type.");
    };
});
var Jc, og, ig, Yc = O(()=>{
    ...
    Jc = (i1, e)=>{
        ...
        let t = G(i1.session.backend.glContext.version), r = e[0].dims.slice(), s = `
      void main() {
    ...
    `;
        ...
        if (!i1 || i1.length === 0) throw new Error("Sum requires inputs.");
        let e = i1[0].dims.length;
        for(let o = 1; o < i1.length; o++){
            if (e !== i1[o].dims.length) throw new Error("Input shapes are mismatched.");
            for(let t = 0; t < e; t++)if (i1[0].dims[t] !== i1[o].dims[t]) throw new Error("Input shapes are not matched.");
        }
        if (i1[0].type !== "float32" && i1[0].type !== "float64") throw new Error("Invalid input type.");
        for(let o = 1; o < i1.length; o++)if (i1[0].type !== i1[o].type) throw new Error("Input types are not matched.");
    };
});
var Zc, ag, sg, Qc = O(()=>{
    "use strict";
...
`)}
    ...
    `;
        ...
        if (!i1 || i1.length !== 2) throw new Error("Tile requires 2 input.");
        if (i1[1].dims.length !== 1) throw new Error("The second input shape must 1 dimension.");
        if (i1[1].dims[0] !== i1[0].dims.length) throw new Error("Invalid input shape.");
        if (Ae.indexOf(i1[0].type) === -1) throw new Error("Invalid input type.");
        if (i1[1].type !== "int32" && i1[1].type !== "int16") throw new Error("Invalid repeat type.");
    };
});
var ki, tp, ep, ug, lg, rp = O(()=>{
    ...
    ki = (i1, e, o)=>{
        ...
        return [
            ...
            e[0]
        ], Array.from(e[1].integerData))), ep = (i1)=>i1.attributes.getInts("axes"), ug = (i1)=>{
        if (!i1 || i1.length !== 1) throw new Error("Unsqueeze requires 1 input.");
        if (i1[0].type === "string") throw new Error("invalid input tensor types.");
    }, lg = (i1)=>{
        if (!i1 || i1.length !== 2) throw new Error("Unsqueeze requires 2 inputs.");
        if (i1[1].type !== "int32") throw new Error("Invalid input type.");
    };
});
var np, op = O(()=>{
...
function hr(i1, e) {
    let o = [], t = [], r = e != null && Array.isArray(e) && e.length === 0, n = e == null || r ? null : cg(e, i1).sort(), s = 0;
    for(let a = 0; a < i1.length; ++a){
        if (n != null) {
            if (n[s] === a && i1[a] !== 1) throw new Error(`Can't squeeze axis ${a} since its dim '${i1[a]}' is not 1`);
            (n[s] == null || n[s] > a) && i1[a] === 1 && (o.push(i1[a]), t.push(a)), n[s] <= a && s++;
        }
        i1[a] !== 1 && (o.push(i1[a]), t.push(a));
    }
    return {
        newShape: o,
        keptDims: t
...
function cg(i1, e) {
    let o = e.length;
    return i1 = i1 == null ? e.map((t, r)=>r) : [].concat(i1), ur(i1.every((t)=>t >= -o && t < o), ()=>`All values in axis param must be in range [-${o}, ${o}) but got axis ${i1}`), ur(i1.every(pg), ()=>`All values in axis param must be integers but got axis ${i1}`), i1.map((t)=>t < 0 ? o + t : t);
}
function pg(i1) {
    return i1 % 1 === 0;
}
function dg(i1) {
    ...
    let e = i1[0];
    for(let o = 1; o < i1.length; o++)e *= i1[o];
    return e;
}
function up(i1) {
    let e = Math.ceil(Math.sqrt(i1));
    return [
        e,
        Math.ceil(i1 / e)
    ];
...
var Gn, Bi = O(()=>{
    ...
    Gn = class {
        ...
        computeTextureWH(e, o) {
            ...
            return o && o.isPacked && (t[0] /= 2, t[1] /= 2), o && o.reverseWH ? [
                t[1],
                t[0]
            ] : t;
        }
        computeTexture(e, o) {
            ...
            let n = e.slice(0);
            t && (r = r * 2, n = n.map((a, u)=>u >= n.length - 2 ? n[u] % 2 === 0 ? n[u] : n[u] + 1 : n[u]), n.length === 1 && (n = [
                2,
                n[0]
            ...
            return n.length <= 1 && s <= r ? [
                1,
                s
            ] : n.length === 2 && n[0] <= r && n[1] <= r ? n : n.length === 3 && n[0] * n[1] <= r && n[2] <= r ? [
                n[0] * n[1],
                n[2]
      ...
      `, new k(r);
        ...
        getOutputPacked3DCoords(o, t) {
            let r = [
                t[0],
                t[1]
            ], n = Math.ceil(o[2] / 2), s = n * Math.ceil(o[1] / 2), a = `
      ...
      `;
        ...
        getOutputPackedNDCoords(o, t) {
            let r = [
                t[0],
                t[1]
            ], n = Math.ceil(o[o.length - 1] / 2), s = n * Math.ceil(o[o.length - 2] / 2), a = s, u = "", l = "b, r, c";
    ...
    `;
        ...
        getUnpackedSamplerAtOutputCoords(o, t, r, n) {
            let s = [
                ...
                t.width,
                t.height
            ], u = t.unpackedShape.length, l = r.unpackedShape.length, f = t.unpackedShape, p = r.unpackedShape, d = On(n);
...
`);
      ...
      `;
        ...
        getPackedSampler1D(o, t, r) {
            let n = [
                ...
                n[1],
                n[0]
            ], a = G(this.context.glContext.version), l = `vec4 ${o}(int index) {
      ...
      return ${a.texture2D}(${t}, uv);
        ...
        getPackedSampler2D(o, t, r) {
            let n = r.unpackedShape, s = [
                r.width,
                r.height
            ], a = G(this.context.glContext.version), u = s[0], l = s[1];
      ...
      return ${u.texture2D}(${t}, uv);}`;
        ...
        getPackedSamplerND(o, t, r) {
            let n = r.unpackedShape, s = n.length, a = [
                r.width,
                r.height
            ], u = G(this.context.glContext.version), l = [
                a[0],
                a[1]
            ], f = l[1], p = l[0], d = Math.ceil(n[s - 1] / 2), y = d * Math.ceil(n[s - 2] / 2), w = "int b, int row, int col", v = `b * ${y} + (row / 2) * ${d} + (col / 2)`;
    ...
    `;
        ...
        valueFrom() {
            ...
            return this.context.programInfo.inputNames.forEach((t, r)=>{
                ...
                o[u] = new k(this.getValueFromSingle(t, a, n.width, n.height, !1), [
                    `shapeUtils.indicesToOffset${u}`,
                    "coordinates.offsetToCoords",
                    "fragcolor.getColorAsFloat"
                ]), u = u + "_T", o[u] = new k(this.getValueFromSingle(t, a, n.width, n.height, !0), [
                    `shapeUtils.indicesToOffset${u}`,
                    "coordinates.offsetToCoords",
                    "fragcolor.getColorAsFloat"
                ]);
...
var Un, fp = O(()=>{
    ...
    Un = class i1 extends Wt {
        ...
        encodeUint8() {
            let e = i1.isLittleEndian() ? "rgba.rgba=rgba.abgr;" : "";
            return {
                encode: new k(`
    ...
    zn = class i1 extends Wt {
        ...
        indicesToOffset() {
            ...
            return this.context.programInfo.inputNames.forEach((o, t)=>{
                ...
                e[a] = new k(i1.indexToOffsetSingle(a, s, n)), a = `indicesToOffset_${o}_T`, e[a] = new k(i1.indexToOffsetSingle(a, s, n.slice().reverse()));
            }), e;
        }
      ...
      `;
        ...
        offsetToIndices() {
            ...
            return this.context.programInfo.inputNames.forEach((o, t)=>{
                ...
                e[a] = new k(i1.offsetToIndicesSingle(a, s, n)), a = `offsetToIndices_${o}_T`, e[a] = new k(i1.offsetToIndicesSingle(a, s, n.slice().reverse()));
            }), e;
        }
...
var Xn, yp = O(()=>{
    ...
    Xn = class {
        constructor(e, o){
            this.backend = e;
            this.context = o;
            this.layoutStrategy = new Gn(e.glContext.maxTextureSize), this.programManager = new qn(this.context.profiler, e.glContext, this.layoutStrategy), this.textureManager = new jn(e.glContext, this.layoutStrategy, this.context.profiler, {
...
${e}`);
        ...
        async addItemToPoll(e, o) {
            this.itemsToPoll.push({
                isDoneFn: e,
                resolveFn: o
            }), !(this.itemsToPoll.length > 1) && await ai(()=>(this.pollItems(), this.itemsToPoll.length === 0));
        }
    };
});
function Ci(i1) {
    let e;
    if ((!i1 || i1 === "webgl2") && "webgl2" in mr ? e = mr.webgl2 : (!i1 || i1 === "webgl") && "webgl" in mr && (e = mr.webgl), !e) try {
        let t = bg();
        e = Tp(t, i1);
    } catch  {
        let r = mg();
    ...
    i1 = i1 || e.version === 1 ? "webgl" : "webgl2";
    let o = e.gl;
    return mr[i1] = e, o.isContextLost() ? (delete mr[i1], Ci(i1)) : (o.disable(o.DEPTH_TEST), o.disable(o.STENCIL_TEST), o.disable(o.BLEND), o.disable(o.DITHER), o.disable(o.POLYGON_OFFSET_FILL), o.disable(o.SAMPLE_COVERAGE), o.enable(o.SCISSOR_TEST), o.enable(o.CULL_FACE), o.cullFace(o.BACK), e);
}
function Tp(i1, e) {
    let o = {
        alpha: !1,
    ...
    if ((!e || e === "webgl2") && (t = i1.getContext("webgl2", r), t)) try {
        return new Mr(t, 2);
    } catch (n) {
        tt.warning("GlContextFactory", `failed to create WebGLContext using contextId 'webgl2'. Error: ${n}`);
    }
    if ((!e || e === "webgl") && (t = i1.getContext("webgl", r) || i1.getContext("experimental-webgl", r), t)) try {
        return new Mr(t, 1);
    } catch (n) {
...
function mg() {
    ...
    let i1 = document.createElement("canvas");
    return i1.width = 1, i1.height = 1, i1;
}
function bg() {
...
var Kn, vp = O(()=>{
    ...
    Kn = class {
        ...
        initialize() {
            try {
                return this.glContext = Ci(this.contextId), typeof this.matmulMaxBatchSize != "number" && (this.matmulMaxBatchSize = 16), typeof this.textureCacheMode != "string" && (this.textureCacheMode = "full"), typeof this.pack != "boolean" && (this.pack = !1), typeof this.async != "boolean" && (this.async = !1), tt.setWithEnv(z), z.webgl.context || Object.defineProperty(z.webgl, "context", {
...
async function Ni(i1) {
    if (i1) {
        let e = typeof i1 == "string" ? [
            i1
        ] : i1;
        for (let o of e){
            let t = Ip.get(o);
...
async function yg(i1) {
    let e = gg;
    if (typeof e[i1] < "u" && xg(e[i1])) {
        let o = e[i1], t = o.initialize();
        if (typeof t == "object" && "then" in t && (t = await t), t) return Ip.set(i1, o), o;
    }
}
function xg(i1) {
    let e = i1;
...
var q, jt, Ur, Sp = O(()=>{
    ...
    ze();
    Y();
    jt = F.experimental.fbs, Ur = class i1 {
        constructor(e){
            if (this._attributes = new Map, e != null) {
                for (let o of e)o instanceof q.onnx.AttributeProto ? this._attributes.set(o.name, [
                    i1.getValue(o),
                    i1.getType(o)
                ]) : o instanceof jt.Attribute && this._attributes.set(o.name(), [
                    i1.getValue(o),
                    i1.getType(o)
                ]);
...
var Mi, Yn, Ui, ce, Zn, Gi, Ap = O(()=>{
    ...
    ze();
    Y();
    Yn = F.experimental.fbs, Ui = {
        from: (i1, e)=>new Gi(i1, e)
    }, ce = class {
        constructor(e){
        ...
        constructor(e, o){
            e instanceof Mi.onnx.NodeProto ? (this.name = e.name, this.opType = e.opType, this.attributes = new Ur(e.attribute)) : e instanceof Yn.Node && (this.name = o ?? e.name(), this.opType = e.opType(), this.attributes = new Ur(_t.tensorAttributesFromORTFormat(e))), this.inputs = [], this.outputs = [], this.executeNode = !0;
        }
    }, Gi = class {
        constructor(e, o){
        ...
        buildGraphFromOnnxFormat(e) {
            ...
            for (let n of e.initializer){
                ...
                if (s === void 0) {
                    ...
                    a.type = {
                        shape: {
                            dims: _t.tensorDimsFromProto(n.dims)
                        },
                        tensorType: _t.tensorDataTypeFromProto(n.dataType)
        ...
        fuseConvActivationNodes() {
            for (let e of this._nodes)if (e.opType === "Conv") {
                ...
                if (o.length === 1 && this.isActivation(this._nodes[o[0]])) {
                    ...
                    else if (t.inputs.length >= 3 && this._allData[t.inputs[1]].tensor !== void 0 && this._allData[t.inputs[2]].tensor !== void 0) e.attributes.set("activation_params", "floats", [
...
as ORT format: ${n}`);
        ...
        loadFromOnnxFormat(e, o) {
            ...
            this._opsets = t.opsetImport.map((n)=>({
                    domain: n.domain,
                    version: Nt.longToNumber(n.version)
                })), this._graph = Ui.from(t.graph, o);
        }
        loadFromOrtFormat(e, o) {
            ...
            for(let s = 0; s < r.opsetImportLength(); s++){
                ...
                this._opsets.push({
                    domain: a?.domain(),
                    version: Nt.longToNumber(a.version())
                });
            }
...
var Bp, Fp, vg, Np = O(()=>{
    ...
    Fp && (self.onmessage = (i1)=>{
        let { type: e, in: o } = i1.data;
        try {
            switch(e){
                case "init-wasm":
                    no(o.wasm).then(()=>{
    ...
    vg = Fp ? null : (i1)=>new Worker(i1 ?? br, {
            type: "module",
            name: Bp
        });
});
...
var Wi, Rp, Ig, Mp = O(()=>{
    "use strict";
    Rp = (Wi = __TURBOPACK__import$2e$meta__.url, async function(i1 = {}) {
        function e() {
        ...
        var s, a, u = Object.assign({}, i1), l = new Promise((c, m)=>{
            s = c, a = m;
        ...
        var y, w, v = globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({
            initial: 0,
            maximum: 0,
            shared: !0
        }).buffer.constructor, S = Object.assign({}, u), L = "./this.program", A = (c, m)=>{
            throw m;
        }, P = "";
            ...
            let c = function(m) {
                try {
                    ...
                    if (x === "load") {
                        ...
                        Eo(g.pthread_ptr, 0, 0, 1, 0, 0), _o(g.pthread_ptr), dd(), ia(), It ||= !0;
                        try {
        ...
        var C, jr, ge, re, ye, Z, xe, ne, oe, pe = !1;
        function lt() {
            var c = C.buffer;
        ...
        function ie(c) {
            throw et(c = "Aborted(" + c + ")"), pe = !0, ge = 1, c = new WebAssembly.RuntimeError(c + ". Build with -sASSERTIONS for more info."), a(c), c;
        }
        ...
        function wr(c, m, g) {
            return (function(x) {
                if (!M && (f || p)) {
                    if (typeof fetch == "function" && !St(x)) return fetch(x, {
        ...
        var ta = {
            ...
            822473: ()=>typeof wasmOffsetConverter < "u"
        };
        function pd() {
        ...
        var aa = (c)=>new Promise((m)=>{
                c.onmessage = (I)=>{
                    ...
                    } else E === "checkMailbox" ? Zr() : E === "spawnThread" ? ea(I) : E === "cleanupThread" ? oa(ae[I.thread]) : E === "killThread" ? (I = I.thread, E = ae[I], delete ae[I], wo(E), Do(I), De.splice(De.indexOf(E), 1), E.Ra = 0) : E === "cancelThread" ? ae[I.thread].postMessage({
                        cmd: "cancel"
        ...
        function sa() {
            var c = new Worker(new URL(__TURBOPACK__import$2e$meta__.url), {
                type: "module",
        ...
        function fa(c, m, g, x) {
            ...
            var I = [];
            return d && I.length === 0 ? la(c, m, g, x) : (c = {
                cb: g,
                Ra: c,
                ab: x,
                ib: I
            }, d ? (c.Za = "spawnThread", postMessage(c, I), 0) : ea(c));
        }
        ...
        function Td(c, m) {
            (c >>>= 0) == m >>> 0 ? setTimeout(Zr) : d ? postMessage({
                targetThread: c,
                cmd: "checkMailbox"
            }) : (c = ae[c]) && c.postMessage({
                cmd: "checkMailbox"
            });
        }
        var Oo = [];
        ...
        var Qe = (c)=>c % 4 == 0 && (c % 100 != 0 || c % 400 == 0), Pa = [
            0,
            31,
            60,
            91,
        ...
        function Ad(c, m, g, x) {
            c >>>= 0, m >>>= 0, g >>>= 0, x >>>= 0;
            var I = new Date().getFullYear(), E = new Date(I, 0, 1), R = new Date(I, 6, 1);
            I = E.getTimezoneOffset();
            var it = R.getTimezoneOffset(), At = Math.max(I, it);
            r()[c >>> 2 >>> 0] = 60 * At, t()[m >>> 2 >>> 0] = +(I != it), E = (c = (Dt)=>Dt.toLocaleTimeString(void 0, {
                    hour12: !1,
                    timeZoneName: "short"
                }).split(" ")[1])(E), R = c(R), it < I ? (_r(E, g, 17), _r(R, x, 17)) : (_r(E, x, 17), _r(R, g, 17));
        }
        var So = [];
        function Pd(c, m, g) {
...
`))[0] == "Error" && x.shift(), ka(x);
        ...
        function za(c, m, g, x) {
            ...
            for(var Bt in x = {
                ...
                "%OW": "%W",
                "%Oy": "%y"
            })g = g.replace(new RegExp(Bt, "g"), Dt[Bt]);
            ...
            for(Bt in Dt = {
                "%a": (_)=>Ka[_.Qa].substring(0, 3),
                "%A": (_)=>Ka[_.Qa],
                "%b": (_)=>Ja[_.Wa].substring(0, 3),
                "%B": (_)=>Ja[_.Wa],
                "%C": (_)=>E((_.Ta + 1900) / 100 | 0, 2),
                "%d": (_)=>E(_.Ya, 2),
                "%e": (_)=>I(_.Ya, 2, " "),
                "%g": (_)=>At(_).toString().substring(2),
                "%G": At,
                "%H": (_)=>E(_.Va, 2),
...
`,
                ...
                "%Z": (_)=>_.hb,
                "%%": ()=>"%"
            }, g = g.replace(/%%/g, "\0\0"), Dt)g.includes(Bt) && (g = g.replace(new RegExp(Bt, "g"), Dt[Bt](x)));
        ...
        var Vd = [
            ...
            return Ze ||= u.locateFile ? Ot("ort-wasm-simd-threaded.wasm") ? "ort-wasm-simd-threaded.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.wasm", P) : P + "ort-wasm-simd-threaded.wasm" : new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.wasm (static in ecmascript)")).href, (function(g, x) {
                var I = Ze;
                return M || typeof WebAssembly.instantiateStreaming != "function" || Ot(I) || St(I) || typeof fetch != "function" ? wr(I, g, x) : fetch(I, {
                    credentials: "same-origin"
        ...
        function Xa() {
            0 < Te || (d ? (s(u), d || Jr(Xr), startWorker(u)) : (Jr(Gt), 0 < Te || tn || (tn = !0, u.calledRun = !0, pe || (d || Jr(Xr), s(u), d || Jr(Je)))));
        }
        return u.___start_em_js = 822530, u.___stop_em_js = 822591, u.stackSave = ()=>$o(), u.stackRestore = (c)=>rn(c), u.stackAlloc = (c)=>Lo(c), u.UTF8ToString = Ir, u.stringToUTF8 = _r, u.lengthBytesUTF8 = ma, Ee = function c() {
            tn || Xa(), tn || (Ee = c);
        }, Xa(), l;
    }), Ig = Rp;
...
var br, _g, Og, Sg, Up, Vp, Ag, zp, Vr = O(()=>{
    "use strict";
    ro();
    br = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : __TURBOPACK__import$2e$meta__.url ?? (typeof document < "u" ? document.currentScript?.src : typeof self < "u" ? self.location?.href : void 0), _g = !1 || typeof location > "u" ? void 0 : location.origin, Og = (i1, e)=>{
        try {
            let o = e ?? br;
            return (o ? new URL(i1, o) : new URL(i1)).origin === _g;
        } catch  {
            return !1;
        }
    }, Sg = async (i1)=>{
        let o = await (await fetch(i1, {
            credentials: "same-origin"
        })).blob();
    ...
    }, Ag = (Mp(), on(Gp)).default, zp = async (i1, e, o)=>[
            void 0,
            Ag
        ];
});
    ...
    qi = !1, co = !1, Wp = !1, Pg = ()=>{
        ...
        if (e > 0 && w.push(new Promise((v)=>{
            ...
            f ? L.wasmBinary = f : (l || n) && (L.locateFile = (A, P)=>l ?? (n ?? P) + A), d(L).then((A)=>{
                co = !1, qi = !0, Hi = A, v(), p && URL.revokeObjectURL(p);
            }, (A)=>{
                co = !1, Wp = !0, S(A);
            });
...
var yt, Wr, ht, po = O(()=>{
    ...
    Xe();
    yt = (i1, e)=>{
        let o = gt(), t = o.lengthBytesUTF8(i1) + 1, r = o._malloc(t);
        return o.stringToUTF8(i1, r, t), e.push(r), r;
    }, Wr = (i1, e, o, t)=>{
        if (typeof i1 == "object" && i1 !== null) {
            if (o.has(i1)) throw new Error("Circular reference in options");
            o.add(i1);
        }
        Object.entries(i1).forEach(([r, n])=>{
            let s = e ? e + r : r;
        ...
        try {
            ...
            throw new Error(`${i1} ERROR_CODE: ${r}, ERROR_MESSAGE: ${s}`);
        } finally{
            e.stackRestore(o);
        }
    };
...
var Hp, qp = O(()=>{
    ...
    Hp = (i1)=>{
        let e = gt(), o = 0, t = [], r = i1 || {};
        try {
            if (i1?.logSeverityLevel === void 0) r.logSeverityLevel = 2;
            else if (typeof i1.logSeverityLevel != "number" || !Number.isInteger(i1.logSeverityLevel) || i1.logSeverityLevel < 0 || i1.logSeverityLevel > 4) throw new Error(`log serverity level is not valid: ${i1.logSeverityLevel}`);
            if (i1?.logVerbosityLevel === void 0) r.logVerbosityLevel = 0;
            else if (typeof i1.logVerbosityLevel != "number" || !Number.isInteger(i1.logVerbosityLevel)) throw new Error(`log verbosity level is not valid: ${i1.logVerbosityLevel}`);
            i1?.terminate === void 0 && (r.terminate = !1);
            let n = 0;
            return i1?.tag !== void 0 && (n = yt(i1.tag, t)), o = e._OrtCreateRunOptions(r.logSeverityLevel, r.logVerbosityLevel, !!r.terminate, n), o === 0 && ht("Can't create run options."), i1?.extra !== void 0 && Wr(i1.extra, "", new WeakSet, (s, a)=>{
    ...
    Dg = (i1)=>{
        switch(i1){
            ...
            case "all":
                return 99;
            default:
                throw new Error(`unsupported graph optimization level: ${i1}`);
        }
    }, Lg = (i1)=>{
        switch(i1){
            case "sequential":
            ...
            case "parallel":
                return 1;
            default:
                throw new Error(`unsupported execution mode: ${i1}`);
        }
    }, $g = (i1)=>{
        i1.extra || (i1.extra = {}), i1.extra.session || (i1.extra.session = {});
        let e = i1.extra.session;
        e.use_ort_model_bytes_directly || (e.use_ort_model_bytes_directly = "1"), i1.executionProviders && i1.executionProviders.some((o)=>(typeof o == "string" ? o : o.name) === "webgpu") && (i1.enableMemPattern = !1);
    }, kg = (i1, e, o)=>{
        for (let t of e){
                ...
                case "webnn":
                    if (r = "WEBNN", typeof t != "string") {
                        ...
                        if (a) {
                            ...
                            gt()._OrtAddSessionConfigEntry(i1, u, l) !== 0 && ht(`Can't set a session config entry: 'deviceType' - ${a}.`);
                        }
                    }
                    break;
                case "webgpu":
                    if (r = "JS", typeof t != "string") {
                        ...
                        if (s?.preferredLayout) {
                            ...
                            gt()._OrtAddSessionConfigEntry(i1, a, u) !== 0 && ht(`Can't set a session config entry: 'preferredLayout' - ${s.preferredLayout}.`);
                        }
                    }
                    break;
                case "wasm":
            ...
            let n = yt(r, o);
            gt()._OrtAppendExecutionProvider(i1, n) !== 0 && ht(`Can't append execution provider: ${r}.`);
        }
    }, jp = (i1)=>{
        let e = gt(), o = 0, t = [], r = i1 || {};
        $g(r);
    ...
    ji = (i1)=>{
        switch(i1){
            ...
            case "uint64":
                return 13;
            default:
                throw new Error(`unsupported data type: ${i1}`);
        }
    }, Kp = (i1)=>{
        switch(i1){
            case 3:
        ...
        switch(i1){
            ...
            default:
                throw new Error(`unsupported type: ${i1}`);
        }
    }, Yp = (i1)=>{
        switch(i1){
            case "verbose":
            ...
            case "fatal":
                return 4;
            default:
                throw new Error(`unsupported logging level: ${i1}`);
        }
    }, ho = (i1)=>i1 === "float32" || i1 === "float16" || i1 === "int32" || i1 === "int64" || i1 === "uint32" || i1 === "uint8" || i1 === "bool", Zp = (i1)=>{
        switch(i1){
            case "none":
                return 0;
            case "cpu":
            ...
            case "gpu-buffer":
                return 4;
            default:
                throw new Error(`unsupported data location: ${i1}`);
        }
    };
});
var Hr, Ji = O(()=>{
    ...
    ro();
    Hr = async (i1)=>{
        if (typeof i1 == "string") if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        else {
            let e = await fetch(i1);
            if (!e.ok) throw new Error(`failed to load external data file: ${i1}`);
            let o = e.headers.get("Content-Length"), t = o ? parseInt(o, 10) : 0;
            if (t < 1073741824) return new Uint8Array(await e.arrayBuffer());
            {
                if (!e.body) throw new Error(`failed to load external data file: ${i1}, no response body.`);
        ...
        else return i1 instanceof Blob ? new Uint8Array(await i1.arrayBuffer()) : i1 instanceof Uint8Array ? i1 : new Uint8Array(i1);
    };
});
var Bg, oo, io, yr, Fg, zr, ao, so, Qp, uo, lo, fo, zi = O(()=>{
    ...
    Ji();
    Bg = (i1, e)=>{
        gt()._OrtInit(i1, e) !== 0 && ht("Can't initialize onnxruntime.");
    }, oo = async (i1)=>{
        Bg(i1.wasm.numThreads, Yp(i1.logLevel));
    }, io = async (i1, e)=>{}, yr = new Map, Fg = (i1)=>{
        let e = gt(), o = e.stackSave();
        try {
            let t = e.stackAlloc(8);
            return e._OrtGetInputOutputCount(i1, t, t + 4) !== 0 && ht("Can't get session input/output count."), [
                e.HEAP32[t / 4],
                e.HEAP32[t / 4 + 1]
            ];
        } finally{
        ...
        let e = gt(), o = e._malloc(i1.byteLength);
        if (o === 0) throw new Error(`Can't create a session. failed to allocate a buffer of size ${i1.byteLength}.`);
        return e.HEAPU8.set(i1, o), [
            o,
            i1.byteLength
        ];
    }, ao = async (i1, e)=>{
        let o, t, r = gt();
        Array.isArray(i1) ? [o, t] = i1 : i1.buffer === r.HEAPU8.buffer ? [o, t] = [
            i1.byteOffset,
            i1.byteLength
        ] : [o, t] = zr(i1);
        ...
        try {
            ...
            for (let A of e?.executionProviders ?? [])if ((typeof A == "string" ? A : A.name) === "webnn") {
                ...
                if (typeof A != "string") {
                    ...
                    V ? r.currentContext = V : ut ? r.currentContext = await navigator.ml.createContext(ut) : r.currentContext = await navigator.ml.createContext({
                        deviceType: xt,
                        numThreads: et,
                        powerPreference: Et
                    });
        ...
        let e = gt(), o = yr.get(i1);
        if (!o) throw new Error(`cannot release session. invalid session id: ${i1}`);
        let [t, r, n, s, a] = o;
        s && (a && e._OrtClearBoundOutputs(s.handle), e._OrtReleaseBinding(s.handle)), e.jsepOnReleaseSession?.(i1), r.forEach((u)=>e._OrtFree(u)), n.forEach((u)=>e._OrtFree(u)), e._OrtReleaseSession(t), yr.delete(i1);
    }, Qp = (i1, e, o, t, r, n = !1)=>{
        if (!i1) {
            e.push(0);
            return;
        }
        let s = gt(), a = i1[0], u = i1[1], l = i1[3], f, p;
        ...
        if (l === "gpu-buffer") {
            let w = i1[2].gpuBuffer, v = Xi(ji(a));
    ...
    }, uo = async (i1, e, o, t, r, n)=>{
        let s = gt(), a = yr.get(i1);
        if (!a) throw new Error(`cannot run inference. invalid session id: ${i1}`);
        ...
        try {
            [S, L] = Hp(n);
            for(let Z = 0; Z < w; Z++)Qp(o[Z], A, M, i1, e[Z], d);
            for(let Z = 0; Z < v; Z++)Qp(r[Z], P, M, i1, w + t[Z], d);
            ...
            for(let Z = 0; Z < v; Z++){
                ...
                let ne = s.stackSave(), oe = s.stackAlloc(4 * 4), pe = !1, lt, Gt = 0;
                try {
                    ...
                    if (lt === "string") {
                        ...
                        pe = !0, ye.push([
                            ...
                            {
                                gpuBuffer: St,
                                download: s.jsepCreateDownloader(St, ie * de, lt),
                                dispose: ()=>{
                        ...
                        new Uint8Array(St.buffer, St.byteOffset, St.byteLength).set(s.HEAPU8.subarray(Gt, Gt + St.byteLength)), ye.push([
                            lt,
                            we,
                            St,
                            "cpu"
            ...
            return p && !d && (s._OrtClearBoundOutputs(p.handle), yr.set(i1, [
                u,
                l,
                f,
                p,
...
var Ke, Xt, qr, bo, go, mo, Yi, Zi, xr, Tr, Ng, td, ed, rd, nd, od, id, ad, Qi = O(()=>{
    ...
    Xe();
    Vr();
    Ke = ()=>!!z.wasm.proxy && typeof document < "u", qr = !1, bo = !1, go = !1, Zi = new Map, xr = (i1, e)=>{
        let o = Zi.get(i1);
        o ? o.push(e) : Zi.set(i1, [
            e
        ]);
    }, Tr = ()=>{
        ...
        switch(i1.data.type){
            case "init-wasm":
                qr = !1, i1.data.err ? (go = !0, Yi[1](i1.data.err)) : (bo = !0, Yi[0]()), mo && (URL.revokeObjectURL(mo), mo = void 0);
                break;
            case "init-ep":
            case "copy-from":
            case "create":
            ...
            case "end-profiling":
                {
                    let e = Zi.get(i1.data.type);
                    i1.data.err ? e.shift()[1](i1.data.err) : e.shift()[0](i1.data.out);
                    break;
                }
            default:
        }
        ...
        if (!bo) {
            ...
            if (qr = !0, Ke()) return new Promise((i1, e)=>{
                Xt?.terminate(), Vp().then(([o, t])=>{
                    try {
                        Xt = t, Xt.onerror = (n)=>e(n), Xt.onmessage = Ng, Yi = [
                            i1,
                            e
                        ];
                        let r = {
            ...
            try {
                await no(z.wasm), await oo(z), bo = !0;
            } catch (i1) {
                throw go = !0, i1;
            } finally{
                qr = !1;
        ...
        await io(z, i1);
    }, rd = async (i1)=>Ke() ? (Tr(), new Promise((e, o)=>{
            xr("copy-from", [
                e,
                o
            ]);
        ...
        if (Ke()) {
            ...
            return Tr(), new Promise((o, t)=>{
                ...
                i1 instanceof Uint8Array && n.push(i1.buffer), Xt.postMessage(r, n);
            });
        } else return ao(i1, e);
    }, od = async (i1)=>{
        if (Ke()) return Tr(), new Promise((e, o)=>{
...
var sd, Rg, yo, ud = O(()=>{
    ...
    sd = (i1, e)=>{
        switch(i1.location){
            ...
            default:
                throw new Error(`invalid data location: ${i1.location} for ${e()}`);
        }
    }, Rg = (i1)=>{
        switch(i1[3]){
            case "cpu":
                return new Tt(i1[0], i1[2], i1[1]);
            case "gpu-buffer":
                {
                    let e = i1[0];
                    if (!ho(e)) throw new Error(`not supported data type: ${e} for deserializing GPU tensor`);
                    let { gpuBuffer: o, download: t, dispose: r } = i1[2];
                    return Tt.fromGpuBuffer(o, {
                        dataType: e,
                        dims: i1[1],
                        download: t,
                        dispose: r
            ...
            default:
                throw new Error(`invalid data location: ${i1[3]}`);
        }
    }, yo = class {
        ...
        async loadModel(e, o) {
            Be();
            let t;
            typeof e == "string" ? ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : t = await this.fetchModelAndCopyToWasmMemory(e) : t = e, [this.sessionId, this.inputNames, this.outputNames] = await nd(t, o), Fe();
        }
        async dispose() {
...
var Gg, xo, ld = O(()=>{
    ...
    Gg = ()=>{
        if ((typeof z.wasm.initTimeout != "number" || z.wasm.initTimeout < 0) && (z.wasm.initTimeout = 0), z.wasm.simd === !1 && console.warn('Deprecated property "env.wasm.simd" is set to false. non-SIMD build is no longer provided, and this setting will be ignored.'), typeof z.wasm.proxy != "boolean" && (z.wasm.proxy = !1), typeof z.wasm.trace != "boolean" && (z.wasm.trace = !1), typeof z.wasm.numThreads != "number" || !Number.isInteger(z.wasm.numThreads) || z.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) z.wasm.numThreads = 1;
            ...
            let i1 = typeof navigator > "u" ? ko("node:os").cpus().length : navigator.hardwareConcurrency;
            z.wasm.numThreads = Math.min(4, Math.ceil((i1 || 1) / 2));
        }
    }, xo = class {
        async init(e) {
...
//# sourceMappingURL=node_modules_onnxruntime-web_dist_1f6211f4._.js.map