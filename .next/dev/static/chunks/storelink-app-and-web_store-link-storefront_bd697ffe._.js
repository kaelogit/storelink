...
function CategoryManager({ sellerId, legacyStoreId, isOpen, onClose, onSuccess }) {
    ...
    const loadCats = async ()=>{
        let q = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*");
        if (legacyStoreId) {
    ...
    const addCategory = async (e)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").insert(row);
...
function DashboardClient({ store, initialProducts, initialOrders, stats }) {
    ...
    const fetchCategories = async ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isProfileBackedStore"])(store)) {
            const bySeller = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").eq("seller_id", uid).order("name");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardClient.useEffect": ()=>{
            const dashboardSync = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('dashboard-realtime').on('postgres_changes', {
                ...
                schema: 'public',
                table: 'categories',
                filter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isProfileBackedStore"])(store) ? `seller_id=eq.${store.owner_id}` : `store_id=eq.${store.id}`
            }, {
                "DashboardClient.useEffect.dashboardSync": ()=>{
        ...
        "DashboardPage.useCallback[loadDashboardData]": async ()=>{
            try {
                ...
                /** Seller with completed onboarding: dashboard from profile (+ optional legacy `stores` id for RPCs). */ if (prof?.is_seller && (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$onboardingState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isProfileOnboardingComplete"])(prof)) {
                    ...
                    setStore(storeForUi);
                    const { data: productsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*, categories(name)").eq("seller_id", user.id).order("created_at", {
                        ascending: false
                    });
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_bd697ffe._.js.map