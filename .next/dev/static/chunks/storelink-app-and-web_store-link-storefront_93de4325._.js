...
"[project]/storelink-app-and-web/store-link-storefront/lib/buyerCategories.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/storelink-app-and-web/store-link-storefront/lib/storefrontCatalogMerge.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchMergedStoreRowsForSellerIds(supabase, sellerIds) {
    ...
    const { data: profiles } = await supabase.from("profiles").select(__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFILE_STOREFRONT_SELECT"]).in("id", needProfile).eq("is_seller", true);
    const synthetic = (profiles || []).map((row)=>{
        const p = row;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileRowToLegacyStoreShape"])(p, {
            legacyStoreId: null
        });
    });
    return [
...
"[project]/storelink-app-and-web/store-link-storefront/components/marketplace/FullMarketplaceClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/lib/buyerCategories.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/lib/storefrontCatalogMerge.ts [app-client] (ecmascript)");
;
...
function FullMarketplaceClient({ initialProducts, categories }) {
    _s();
    const { addToCart, cartCount, setIsCartOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const PAGE_SIZE = 12;
    // --- 1. CORE STATES ---
    ...
    const [hasMore, setHasMore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [page, setPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Math.ceil(initialProducts.length / PAGE_SIZE));
    ...
    const [selectedCategory, setSelectedCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    ...
    const [flashOnly, setFlashOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const trendingDrops = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
    ...
    const rankStore = (stores)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["effectiveSellerTier"])(stores?.subscription_plan, stores?.subscription_expiry, stores?.subscription_status) === "diamond" ? 2 : 1;
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FullMarketplaceClient.useEffect": ()=>{
            const mergeProductRows = {
                "FullMarketplaceClient.useEffect.mergeProductRows": async (rows)=>{
                    const list = rows || [];
                    const sellerIds = [
                        ...new Set(list.map({
                            "FullMarketplaceClient.useEffect.mergeProductRows": (p)=>p.seller_id
                        }["FullMarketplaceClient.useEffect.mergeProductRows"]).filter(Boolean))
                    ];
                    if (sellerIds.length === 0) return [];
                    const storeRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMergedStoreRowsForSellerIds"])(__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"], sellerIds);
                    const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attachStoresToProducts"])(list, storeRows);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dropProductsWithoutStore"])(merged);
                }
            }["FullMarketplaceClient.useEffect.mergeProductRows"];
            const fetchFiltered = {
                "FullMarketplaceClient.useEffect.fetchFiltered": async ()=>{
                    ...
                    setLoading(true);
                    setPage(1);
                    let query = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("storefront_products").select("*").eq("is_active", true).order("created_at", {
                        ascending: false
                    }).range(0, 40);
                    if (selectedCategory !== "all") {
                        const cat = categories.find({
                            "FullMarketplaceClient.useEffect.fetchFiltered.cat": (c)=>c.slug === selectedCategory
                        }["FullMarketplaceClient.useEffect.fetchFiltered.cat"]);
                        if (!cat?.id) {
                            setProducts([]);
                            setHasMore(false);
                            setLoading(false);
                    ...
                    let processed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["excludeServiceStoresFromMarketplaceProducts"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyMarketplaceStoreCaps"])(merged));
                    if (debouncedSearch) {
                        processed = processed.sort({
                            "FullMarketplaceClient.useEffect.fetchFiltered": (a, b)=>rankStore(b.stores) - rankStore(a.stores)
    ...
    const loadMore = async ()=>{
        ...
        if (newProducts && newProducts.length > 0) {
            ...
            const storeRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMergedStoreRowsForSellerIds"])(__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"], sellerIds);
            const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attachStoresToProducts"])(newProducts, storeRows);
            const joined = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$storefrontCatalogMerge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dropProductsWithoutStore"])(merged);
            const protectedNewData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$buyerCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["excludeServiceStoresFromMarketplaceProducts"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyMarketplaceStoreCaps"])(joined));
            setProducts((prev)=>[
                    ...prev,
                    ...protectedNewData
                ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            trendingDrops.length > 0 && !search && !flashOnly && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            coins > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: products.map((product)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            product.stock_quantity === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            isDiamond && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            hasMore && products.length >= 12 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            cartCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(FullMarketplaceClient, "UWqMEV+cidREezAr76qyUlpgzXs=", false, function() {
    return [
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_93de4325._.js.map