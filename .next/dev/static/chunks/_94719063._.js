...
function WalletPage() {
    ...
    const fetchWalletStatus = async (userPhone)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_wallets').select('*')// 🔥 FIXED: Changed 'phone' to 'phone_number'
    ...
    const unlockAndFetchHistory = async ()=>{
        setLoading(true);
        const { data: history } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('coin_transactions').select('*').eq('phone', phone).order('created_at', {
            ascending: false
        });
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    transactions.length > 0 ? transactions.map((tx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(WalletPage, "qk9yf2rgF6Z6ufbv9alI4gj2gWE=");
_c = WalletPage;
;
var _c;
...
//# sourceMappingURL=_94719063._.js.map