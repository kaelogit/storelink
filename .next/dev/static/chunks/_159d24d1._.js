...
function VerificationPage() {
    ...
    const [note, setNote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // 👈 Added State for the Reason
    ...
    async function fetchStatus() {
        ...
        if (!user) return;
        const { data: store } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stores').select('id, name, verification_status, verification_doc_url, verification_note').eq('owner_id', user.id).single();
        if (store) {
            setStoreId(store.id);
...
_s(VerificationPage, "HQ7MDwIvCL0FSnkja9+YBuFyzOk=");
_c = VerificationPage;
var _c;
...
//# sourceMappingURL=_159d24d1._.js.map