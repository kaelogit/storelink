...
function FullMarketplaceClient({ initialProducts, categories }) {
    ...
    const [hasMore, setHasMore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialProducts.length >= BATCH_SIZE);
    const [page, setPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Math.max(1, Math.ceil(initialProducts.length / BATCH_SIZE)));
        ...
        "FullMarketplaceClient.useEffect": ()=>{
            ...
            const fetchFiltered = {
                "FullMarketplaceClient.useEffect.fetchFiltered": async ()=>{
                    ...
                    setLoading(true);
                    setPage(1);
                    const categoryName = selectedCategory !== "all" ? categories.find({
                        "FullMarketplaceClient.useEffect.fetchFiltered": (c)=>c.slug === selectedCategory
                    }["FullMarketplaceClient.useEffect.fetchFiltered"])?.name || null : null;
                    ...
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("get_storefront_marketplace_products", {
                        p_limit: BATCH_SIZE,
                        p_offset: 0,
    ...
    const loadMore = async ()=>{
        ...
        const { data: newProducts } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("get_storefront_marketplace_products", {
            p_limit: BATCH_SIZE,
            p_offset: from,
            p_category: categoryName,
            p_search: debouncedSearch || null,
...
_s(FullMarketplaceClient, "wjy/UkGPQ34xCqc6h7dgF9T9TF4=", false, function() {
    return [
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_fbe28606._.js.map