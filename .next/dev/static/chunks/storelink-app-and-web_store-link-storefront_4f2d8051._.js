...
function FullMarketplaceClient({ initialProducts, categories }) {
        ...
        "FullMarketplaceClient.useEffect": ()=>{
            const mergeProductRows = {
                "FullMarketplaceClient.useEffect.mergeProductRows": async (rows)=>{
                    ...
                    const { data: storeRows } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("*").in("owner_id", sellerIds);
            ...
            const fetchFiltered = {
                "FullMarketplaceClient.useEffect.fetchFiltered": async ()=>{
                    ...
                    setLoading(true);
                    setPage(1);
                    let ownerIdsForCategory = null;
                    if (selectedCategory !== "all") {
                        const { data: catStores } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("owner_id").eq("category", selectedCategory);
                        ownerIdsForCategory = (catStores || []).map({
                            "FullMarketplaceClient.useEffect.fetchFiltered": (s)=>s.owner_id
                        }["FullMarketplaceClient.useEffect.fetchFiltered"]).filter(Boolean);
                        if (ownerIdsForCategory.length === 0) {
                            setProducts([]);
                            setHasMore(false);
                            setLoading(false);
                            return;
                    ...
                    if (ownerIdsForCategory) {
                        query = query.in("seller_id", ownerIdsForCategory);
                    }
                    if (debouncedSearch) {
    ...
    const loadMore = async ()=>{
        ...
        if (selectedCategory !== "all") {
            const { data: catStores } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("stores").select("owner_id").eq("category", selectedCategory);
            ownerIdsForCategory = (catStores || []).map((s)=>s.owner_id).filter(Boolean);
            if (ownerIdsForCategory.length === 0) {
                setHasMore(false);
                setLoading(false);
                return;
        ...
        if (ownerIdsForCategory) query = query.in("seller_id", ownerIdsForCategory);
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_4f2d8051._.js.map