...
function WalletPage() {
    ...
    const unlockAndFetchHistory = async ()=>{
        setLoading(true);
        const { data: history } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('coin_transactions').select('*').eq('phone', phoneNumber).order('created_at', {
            ascending: false
        });
...
//# sourceMappingURL=_f8ba4a45._.js.map