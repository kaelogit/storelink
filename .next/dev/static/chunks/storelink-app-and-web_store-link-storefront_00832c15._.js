            ...
            if (isOpen) {
                ...
                const loadData = {
                    "AddProductModal.useEffect.loadData": async ()=>{
                        ...
                        if (tierPlan != null) {
                            setUserPlan((0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$utils$2f$marketplaceDiscovery$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["effectiveSellerTier"])(tierPlan, tierExpiry, tierStatus));
                        }
                    }
...
_s(AddProductModal, "+klzDRXogrPSUOdZtfwopMc06vg=", false, function() {
    return [
...
function CategoryManager({ sellerId, isOpen, onClose, onSuccess }) {
    ...
    const loadCats = async ()=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").eq("seller_id", sellerId).eq("category_scope", "seller").order("created_at", {
            ascending: true
        });
        setCategories(data || []);
    };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                            ...
                            children: [
                                categories.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                ...
                                categories.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
function DashboardClient({ store, initialProducts, initialOrders, stats }) {
    ...
    const fetchCategories = async ()=>{
        ...
        const primary = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").eq("seller_id", uid).eq("category_scope", "seller").order("name");
        if (!primary.error && primary.data?.length) {
            setLiveCategories(primary.data);
            return;
        }
        const { data: prodRows } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("category_id").eq("seller_id", uid);
        const ids = [
        ...
        const { data: cats } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*").in("id", ids).order("name");
...
"[project]/storelink-app-and-web/store-link-storefront/lib/displayRegion.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getDefaultMarketCountryCode() {
    const raw = typeof __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_DEFAULT_MARKET_COUNTRY_CODE?.trim() || "";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$displayRegion$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/lib/displayRegion.ts [app-client] (ecmascript)");
;
...
function joinProfileDisplayLocation(p) {
    const full = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$displayRegion$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["displayLocationFull"])({
        location: p.location,
...
function profileRowToLegacyStoreShape(p, opts) {
    ...
    return {
        ...
        location: (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$displayRegion$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["displayLocationFull"])({
            location: p.location,
            location_city: p.location_city,
            location_state: p.location_state,
            location_country: p.location_country,
        ...
        "DashboardPage.useCallback[loadDashboardData]": async ()=>{
            try {
                ...
                const [{ data: storeData }, { data: prof }] = await Promise.all([
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select(`${__TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFILE_STOREFRONT_SELECT"]}, onboarding_completed, onboarding_step`).eq("id", user.id).maybeSingle()
                ]);
                ...
                /** Seller with completed onboarding: dashboard from profile (+ optional legacy `stores` id for RPCs). */ if (prof?.is_seller && (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$onboardingState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isProfileOnboardingComplete"])(prof)) {
                    setBuyerHome(null);
                    const synthetic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$profileAsStorefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileRowToLegacyStoreShape"])(prof, {
                    ...
                    setStore(storeForUi);
                    const { data: productsData, error: productsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*, categories(name)").eq("seller_id", user.id).order("created_at", {
                        ascending: false
                    });
                    let productRows = productsData || [];
                    if (productsError) {
                        console.warn("Dashboard products query:", productsError.message);
                        const { data: fallback } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").eq("seller_id", user.id).order("created_at", {
                            ascending: false
                        });
                        productRows = fallback || [];
                    }
                    setProducts(productRows);
                    const { data: ordersData } = await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("orders").select("*").eq("seller_id", user.id).order("created_at", {
                        ascending: false
                    });
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_00832c15._.js.map