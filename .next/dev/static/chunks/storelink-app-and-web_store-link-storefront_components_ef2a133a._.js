...
function StoreFront({ store, products: initialProducts, categories }) {
    ...
    const initialProductsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(initialProducts);
        ...
        "StoreFront.useEffect": ()=>{
            const fetchStoreProducts = {
                "StoreFront.useEffect.fetchStoreProducts": async ()=>{
                    ...
                    setLoading(true);
                    let query = __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("storefront_products").select("*").eq("seller_id", store.owner_id).eq("is_active", true).order("created_at", {
                        ascending: false
                    });
                    if (activeCategory !== "All") {
                        const cat = categories.find({
                            "StoreFront.useEffect.fetchStoreProducts.cat": (c)=>c.name === activeCategory
                        }["StoreFront.useEffect.fetchStoreProducts.cat"]);
                        if (!cat?.id) {
                            setProducts([]);
                            setLoading(false);
                            return;
...
_s(StoreFront, "MLRw/B0osLnHLYoTrbd2j+BKXEc=", false, function() {
    return [
...
"[project]/storelink-app-and-web/store-link-storefront/components/ViewTracker.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>ProfileStorefrontViewTracker
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/storelink-app-and-web/store-link-storefront/lib/supabase.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
...
;
;
function ProfileStorefrontViewTracker({ profileId }) {
    _s();
    const hasCounted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfileStorefrontViewTracker.useEffect": ()=>{
            const sessionKey = `viewed_profile_storefront_${profileId}`;
            if (sessionStorage.getItem(sessionKey) || hasCounted.current) {
                return;
            }
            const countView = {
                "ProfileStorefrontViewTracker.useEffect.countView": async ()=>{
                    try {
                        hasCounted.current = true;
                        sessionStorage.setItem(sessionKey, "true");
                        await __TURBOPACK__imported__module__$5b$project$5d2f$storelink$2d$app$2d$and$2d$web$2f$store$2d$link$2d$storefront$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("increment_profile_storefront_view", {
            ...
            }["ProfileStorefrontViewTracker.useEffect.countView"];
            countView();
        }
    }["ProfileStorefrontViewTracker.useEffect"], [
        profileId
...
_s(ProfileStorefrontViewTracker, "9Z+fsgMExtclPh9jzdjOtBESKAo=");
_c = ProfileStorefrontViewTracker;
var _c;
__turbopack_context__.k.register(_c, "ProfileStorefrontViewTracker");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=storelink-app-and-web_store-link-storefront_components_ef2a133a._.js.map