...
import { Check, Crown, Star, Shield, AlertTriangle, Loader2, ArrowLeft } from "lucide-react";
...
export default function SubscriptionPage() {
  ...
  const getPaystackConfig = (amount: number, plan: 'premium' | 'diamond') => {
    return {
      ...
      amount: amount * 100, // Paystack is in Kobo (2500 * 100)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-12 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-500 mb-10">Choose the plan that fits your business scale.</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              {currentPlan !== 'free' && <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-md">Active</span>}
            </div>
            {expiryDate && (
